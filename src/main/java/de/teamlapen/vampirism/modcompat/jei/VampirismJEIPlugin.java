...
public class VampirismJEIPlugin implements IModPlugin {
    ...
    private Collection<Object> getRepairRecipes(IVanillaRecipeFactory factory) {
        ...
        items.put(leather, Lists.newArrayList(ModItems.armor_of_swiftness_chest_normal.get(), ModItems.armor_of_swiftness_chest_enhanced.get().get(), ModItems.armor_of_swiftness_chest_ultimate.get(), ModItems.armor_of_swiftness_head_normal.get(), ModItems.armor_of_swiftness_head_enhanced.get(), ModItems.armor_of_swiftness_head_ultimate.get(), ModItems.armor_of_swiftness_legs_normal.get(), ModItems.armor_of_swiftness_legs_enhanced.get(), ModItems.armor_of_swiftness_legs_ultimate.get(), ModItems.armor_of_swiftness_feet_normal.get(), ModItems.armor_of_swiftness_feet_enhanced.get(), ModItems.armor_of_swiftness_feet_ultimate.get()));
        ...
        items.put(enhancedBloodIngot, Lists.newArrayList(ModItems.heart_seeker_enhanced.get(), ModItems.heart_seeker_ultimate.get().get(), ModItems.heart_striker_enhanced.get(), ModItems.heart_striker_ultimate.get().get()));
