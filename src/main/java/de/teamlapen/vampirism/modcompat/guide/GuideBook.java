...
public class GuideBook implements IGuideBook {
    ...
    private static Map<ResourceLocation, EntryAbstract> buildVampire() {
        ...
        lordPages.add(lordTitleBuilder.build());//        lordPages.addAll(GuideHelper.addLinks(PageHelper.pagesForLongText(translate(base + "lord.minion", loc(ModItems.vampire_minion_binding), loc(ModItems.vampire_minion_upgrade1), loc(ModItems.vampire_minion_upgrade2))), new ResourceLocation("guide.vampirism.items.vampire_minion_binding"))); TODO 1.16
