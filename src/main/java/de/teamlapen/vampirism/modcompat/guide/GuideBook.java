...
public class GuideBook implements IGuideBook {
    ...
    private static Map<ResourceLocation, EntryAbstract> buildItems(BookHelper helper) {
        ...
        helper.info(ModItems.holy_water_bottle_normal, ModItems.holy_water_bottle_enhanced, ModItems.holy_water_bottle_ultimate).setLinks(new ResourceLocation("guide.vampirism.hunter.vamp_slayer"), new ResourceLocation("guide.vampirism.items.pure_salt")).setFormats(loc(ModItems.pure_salt_water), loc(ModItems.pure_salt_water), loc(ModItems.pure_salt)).brewingItems(ModItems.pure_salt_water, ModItems.holy_water_splash_bottle_normal).setKeyName("holy_water_bottle").build(entries);
        helper.info(ModItems.pure_salt).setLinks(new ResourceLocation("guide.vampirism.items.holy_water_bottle")).setFormats(loc(ModBlocks.alchemical_cauldron)).recipes("alchemical_cauldron/pure_salt").build(entries);
