...
public class GuideBook implements IGuideBook {
    ...
    private static @NotNull Map<ResourceLocation, EntryAbstract> buildBlocks(@NotNull BookHelper helper) {
        ...
        helper.info(ModBlocks.GARLIC_DIFFUSER_NORMAL.get(), ModBlocks.GARLIC_DIFFUSER_WEAK.get(), ModBlocks.GARLIC_DIFFUSER_WEAK.get()).setFormats(cn, cn, ce, ce, loc(ModItems.PURIFIED_GARLIC.get())).useCustomEntryName().setKeyName("garlic_diffuser").setLinks(VResourceLocation.mod("guide.vampirism.items.item_garlic"), VResourceLocation.mod("guide.vampirism.items.purified_garlic"), VResourceLocation.mod("guide.vampirism.items.holy_water_bottle")).recipes("hunter/garlic_diffuser_normal", "hunter/garlic_diffuser_improved", "garlic_diffuser_core", "garlic_diffuser_core_improved").build(entries);
