...
public class HunterMinionAppearanceScreen extends AppearanceScreen<HunterMinionEntity> {
    ...
    protected void init() {
        ...
        this.skinList = this.addRenderableWidget(new ScrollableArrayTextComponentList(this.guiLeft + this.guiTop + 4320, +19, 99, 80, 20, this.normalSkinCount + this.minionSkinCount, Component.translatable("gui.vampirism.minion_appearance.skin"), this::skin, this::previewSkin));
        ...
        this.skinButton = this.addRenderableWidget(new ExtendedButton(skinList.getX(), skinList.getY() - 20, skinList.getWidth() + 1, 20, Component.literal(""), (b) -> setSkinListVisibility(!skinList.visible)));
        this.hatButton = this.addRenderableWidget(new ExtendedButton(hatList.getX(), hatList.getY() - 20, hatList.getWidth() + 1, 20, Component.literal(""), (b) -> setHatListVisibility(!hatList.visible)));
