...
public class MinionScreen extends ContainerScreen<MinionContainer> {
    ...
    protected void init() {
        ...
        this.taskList = this.addButton(new ScrollableListButton(this.guiLeft + 119, this.guiTop + 19 + 19, 87, Math.min(60, 20 * taskNames.length), taskNames.length, taskNames, new StringTextComponent(""), this::selectTask, false));
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack mStack, int mouseX, int mouseY) {
        this.font.func_243246_a(mStack, title, 5, 6.0F, 0x404040);
        this.font.func_243246_a(mStack, new TranslationTextComponent("gui.vampirism.minion.active_task"), 120, 10.0F, 0x404040);
