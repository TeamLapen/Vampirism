...
public class HunterMinionAppearanceScreen extends AppearanceScreen<HunterMinionEntity> {
    ...
    private GuiButtonExt skinButton;
    private GuiButtonExt hatButton;
    ...
    protected void init() {
        ...
        this.skinList = this.addButton(new ScrollableListButton(this.guiLeft + 20, this.guiTop + 43 + 19, 99, 5, HunterMinionRenderer.TEXTURE_COUNT, null, UtilLib.translate("gui.vampirism.minion_appearance.skin"), this::skin, false));
        ...
        this.skinButton = this.addButton(new GuiButtonExt(skinList.x, skinList.y - 20, skinList.getWidth() + 1, 20, "", (b) -> {
            setSkinListVisibility(!skinList.visible);
        }));
        this.hatButton = this.addButton(new GuiButtonExt(hatList.x, hatList.y - 20, hatList.getWidth() + 1, 20, "", (b) -> {
