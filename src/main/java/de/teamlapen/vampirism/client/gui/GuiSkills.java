...
public class GuiSkills extends GuiScreen implements GuiYesNoCallback {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 2) {
            ...
            GuiYesNo resetGui = new GuiYesNo(this, UtilLib.translate("gui.vampirism.resetSkills.title"), UtilLib.translate("gui.vampirism.resetSkills." + (test ? "descTest" : "desc")), 10);
