...
public class ModKeys {
    ...
    private static final KeyBinding ACTION = new KeyBinding(TOGGLE_ACTIONS, KeyConflictContext.IN_GAME, InputMappings.Type.KEYSYM, GLFW.GLFW_KEY_R, CATEGORY);//Middle Mouse -98
