...
public class BaronAttireLayer extends RenderLayer<VampireBaronEntity, BaronWrapperModel> {
     ...
     */
    public BaronAttireLayer(RenderLayerParent<VampireBaronEntity, BaronWrapperModel> entityRendererIn, Predicate<VampireBaronEntity> predicateFemale) {
    ...
    @Override
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, VampireBaronEntity entityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
