...
@OnlyIn(Dist.CLIENT)
public class RenderHunterTrainer extends BipedRenderer<EntityHunterTrainer> {
    ...
    public RenderHunterTrainer(EntityRendererManager renderManagerIn) {
    ...
    @Override
    protected void renderLivingLabel(EntityHunterTrainer entityIn, String str, double x, double y, double z, int maxDistance) {
