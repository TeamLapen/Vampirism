...
public class DummyHunterTrainerRenderer extends BipedRenderer<DummyHunterTrainerEntity, BasicHunterModel<DummyHunterTrainerEntity>> {
    ...
    @Override
    public ResourceLocation getEntityTexture(DummyHunterTrainerEntity entity) {
        return texture;
    }

    @Override
    protected void renderName(DummyHunterTrainerEntity p_225629_1_, String p_225629_2_, MatrixStack p_225629_3_, IRenderTypeBuffer p_225629_4_, int p_225629_5_) {
