 ...
 */
@OnlyIn(Dist.CLIENT)
public class RenderThrowableItem extends SpriteRenderer<EntityThrowableItem> {
    public RenderThrowableItem(EntityRendererManager renderManagerIn, ItemRenderer itemRendererIn) {
