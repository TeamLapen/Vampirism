 ...
 */
public class BaronModel extends EntityModel<VampireBaronEntity> implements IHasArm, IHasHead {
    protected RendererModel body;
    protected RendererModel headOverlay;
    protected RendererModel legRightOverlay;
    protected RendererModel legLeftOverlay;
    protected RendererModel armRightOverlay;
    protected RendererModel armLeftOverlay;
    protected RendererModel bodyOverlay;
    ...
    protected RendererModel clawsRight;
    protected RendererModel clawsLeft;
