 ...
 */
@OnlyIn(Dist.CLIENT)
public class BipedShrinkableModel<T extends LivingEntity> extends BipedModel<T> {

    private float size = 1F;

    public BipedShrinkableModel() {
        super();
    }

    public BipedShrinkableModel(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn) {
