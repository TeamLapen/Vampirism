...
public abstract class PlayerModifiers {
	...
	public static void applyModifiers(int level,EntityPlayer p){
		...
		//Nightvision after 1.8 maybe see net.minecraft.client.renderer.EntityRenderer.updateLightmap(float)
	...
	/**
	 * Calculates the modifier effect. In lower levels the effect changes greater.
	 * @param level Vampire level
	 * @param lcap Level the modifier does not get any stronger
	 * @param maxMod Max modifier effect
	 * @param slope 
