...
public class MinionInventoryCommand extends BasicCommand {
        ...
        return Commands.literal("modifyMinionInventory")
                ...
                .then(Commands.argument("minion", MinionArgument.minions())
                        .then(Commands.literal("list")
                                .executes(context -> listInventory(context.getSource(), context.getSource().getPlayerOrException(), ResourceLocationArgument.getId(context, "minion"))))
                        .then(Commands.literal("remove")
                                .then(Commands.argument("item", ItemArgument.item())
                                        .executes(context -> removeItem(context.getSource(), context.getSource().getPlayerOrException(), ResourceLocationArgument.getId(context, "minion"), ItemArgument.getItem(context, "item"), 1))
                                        .then(Commands.argument("count", IntegerArgumentType.integer(1))
                                                .executes(context -> removeItem(context.getSource(), context.getSource().getPlayerOrException(), ResourceLocationArgument.getId(context, "minion"), ItemArgument.getItem(context, "item"), IntegerArgumentType.getInteger(context, "count"))))))
                        .then(Commands.literal("add")
                                .then(Commands.argument("item", ItemArgument.item())
                                        .executes(context -> addItem(context.getSource(), context.getSource().getPlayerOrException(), ResourceLocationArgument.getId(context, "minion"), ItemArgument.getItem(context, "item"), 1))
                                        .then(Commands.argument("count", IntegerArgumentType.integer(1))
                                                .executes(context -> addItem(context.getSource(), context.getSource().getPlayerOrException(), ResourceLocationArgument.getId(context, "minion"), ItemArgument.getItem(context, "item"), IntegerArgumentType.getInteger(context, "count")))))));
    }

    private static int addItem(CommandSource source, ServerPlayerEntity player, ResourceLocation playerMinionIdentifier, ItemInput item, int count) throws CommandSyntaxException {
    ...
    private static int removeItem(CommandSource source, ServerPlayerEntity player, ResourceLocation playerMinionIdentifier, ItemInput item, int count) throws CommandSyntaxException {
        getInventory(playerMinionIdentifier).ifPresent(minionInventory -> {
    ...
    private static int listInventory(CommandSource source, ServerPlayerEntity player, ResourceLocation playerMinionIdentifier) throws CommandSyntaxException {
        Optional<MinionInventory> inventory = getInventory(playerMinionIdentifier);
    ...
    private static Optional<MinionInventory> getInventory(ResourceLocation playerMinionIdentifier) throws CommandSyntaxException {
        String playerName = playerMinionIdentifier.getNamespace();
        int minionId = Integer.parseInt(playerMinionIdentifier.getPath().split("/")[0]);
        ...
        return controller.contactMinionData(minionId, (MinionData::getInventory));
    }
}
