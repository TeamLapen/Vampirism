    ...
    private static int spawnNewMinion(CommandSource ctx) throws CommandSyntaxException {
        ...
        if (fph.getMaxMinions() > 0) {
            ...
            if (controller.hasFreeMinionSlot()) {
                int id = controller.createNewMinion(new VampireMinionEntity.VampireMinionData(20, new StringTextComponent("Minion").mergeStyle(TextFormatting.RED), p.getRNG().nextInt(IBasicVampire.TYPES)));
                if (id < 0) {
