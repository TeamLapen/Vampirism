...
public class VampirismContainer extends InventoryContainer implements TaskContainer {
    ...
    private static final Function<PlayerEntity, SelectorInfo[]> SELECTOR_INFOS = player -> {
        ...
        return new SelectorInfo[]{
                ...
                new SelectorInfo(stack -> stack.getItem() instanceof IRefinementItem && ((IRefinementItem) stack.getItem()).getSlotType() == IRefinementItem.AccessorySlotType.OBI_BELT && ((IRefinementItem) stack.getItem()).getExclusiveFaction().equals(faction), 58, 44)};
    };
