...
public class MinionContainer extends InventoryContainer {
    ...
    private static SelectorInfo[] createSelectors(MinionEntity<?> minionEntity, int extraSlots) {
        ...
        slots[0] = new SelectorInfo(factionPredicate.and(stack -> stack.canEquip(EquipmentSlotType.MAINHAND, minionEntity)), 7, 42, false, 1, null);
        slots[1] = new SelectorInfo(factionPredicate.and(stack -> stack.canEquip(EquipmentSlotType.OFFHAND, minionEntity)), 7, 60, false, 1, null);
