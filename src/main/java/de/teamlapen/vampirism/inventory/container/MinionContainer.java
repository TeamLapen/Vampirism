...
public class MinionContainer extends InventoryContainer {
    ...
    @Nullable
    public static MinionContainer create(int id, PlayerInventory playerInventory, MinionEntity<?> minionEntity, ILordPlayer lord) {
    ...
    public MinionContainer(int id, PlayerInventory playerInventory, ILordPlayer lord, MinionEntity<?> minionEntity, @Nonnull IInventory inventory, int extraSlots, SelectorInfo... selectorInfos) {
