    ...
    public static void registerRefinements(@Nonnull IForgeRegistry<IRefinement> registry) {
        {
            ...
            {
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("708c05bb-a12c-4868-93c1-9f1cb3cd40c8"), 1, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage", value, AttributeModifier.Operation.ADDITION)).setRegistryName(REFERENCE.MODID, "damage1"));
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("7fb3050d-364f-4ced-9587-9549ff90e9e4"), 2, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage", value, AttributeModifier.Operation.ADDITION)).setRegistryName(REFERENCE.MODID, "damage2"));
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("e314753b-e77c-4cf5-bb9f-885049c060d0"), 3, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage", value, AttributeModifier.Operation.ADDITION)).setRegistryName(REFERENCE.MODID, "damage3"));
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("f44829f6-0321-4410-b750-745689172515"), -1, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage_debuff", value, AttributeModifier.Operation.ADDITION)).setRegistryName(REFERENCE.MODID, "n_damage1"));
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("f6fabcf6-2daa-43dd-8d93-e6580f88270f"), -2, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage_debuff", value, AttributeModifier.Operation.ADDITION)).setRegistryName(REFERENCE.MODID, "n_damage2"));
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("f936f64b-65f4-4ba0-b35b-2cb5b078cbf0"), -3, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage_debuff", value, AttributeModifier.Operation.ADDITION)).setRegistryName(REFERENCE.MODID, "n_damage3"));
