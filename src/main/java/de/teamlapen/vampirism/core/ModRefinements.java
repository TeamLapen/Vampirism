    ...
    public static void registerRefinements(@Nonnull IForgeRegistry<IRefinement> registry) {
        {
            ...
            }
            {
                ...
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("f44829f6-0321-4410-b750-745689172515"), -0.5, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage_debuff", value, AttributeModifier.Operation.ADDITION)).setDetrimental().setRegistryName(REFERENCE.MODID, "n_damage1"));
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("f6fabcf6-2daa-43dd-8d93-e6580f88270f"), -1, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage_debuff", value, AttributeModifier.Operation.ADDITION)).setDetrimental().setRegistryName(REFERENCE.MODID, "n_damage2"));
                registry.register(new Refinement(Attributes.ATTACK_DAMAGE, UUID.fromString("f936f64b-65f4-4ba0-b35b-2cb5b078cbf0"), -1.5, (uuid, value) -> new AttributeModifier(uuid, "refinement_damage_debuff", value, AttributeModifier.Operation.ADDITION)).setDetrimental().setRegistryName(REFERENCE.MODID, "n_damage3"));
            }
            {
                ...
                registry.register(new Refinement(Attributes.ATTACK_SPEED, UUID.fromString("04835850-7441-4ddb-871c-964023f6027b"), -0.1, (uuid, value) -> new AttributeModifier(uuid, "refinement_attack_speed_debuff", value, AttributeModifier.Operation.MULTIPLY_BASE)).setDetrimental().setRegistryName(REFERENCE.MODID, "n_attack_speed1"));
                registry.register(new Refinement(Attributes.ATTACK_SPEED, UUID.fromString("813f4b7f-5aee-407e-a506-872989e7155b"), -0.2, (uuid, value) -> new AttributeModifier(uuid, "refinement_attack_speed_debuff", value, AttributeModifier.Operation.MULTIPLY_BASE)).setDetrimental().setRegistryName(REFERENCE.MODID, "n_attack_speed2"));
                registry.register(new Refinement(Attributes.ATTACK_SPEED, UUID.fromString("0f9e6e75-8362-4863-978e-9adc337839d6"), -0.3, (uuid, value) -> new AttributeModifier(uuid, "refinement_attack_speed_debuff", value, AttributeModifier.Operation.MULTIPLY_BASE)).setDetrimental().setRegistryName(REFERENCE.MODID, "n_attack_speed3"));
            }
        }
        { // simple refinements
