...
public class ModTasks {
    ...
    static {
        ...
        //Generic tasks
        TASKS.register("v_infect1", () -> TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("infect", ModStats.infected_creatures, 20).setItemReward(() -> new ItemStack(Items.GOLD_INGOT, 5)).build());
        TASKS.register("v_infect2", () -> TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("infect", ModStats.infected_creatures, 25).setItemReward(() -> new ItemStack(Items.GOLD_INGOT, 15)).build());
        TASKS.register("v_infect3", () -> TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("infect", ModStats.infected_creatures, 15).setItemReward(() -> new ItemStack(Items.IRON_INGOT, 5)).build());
        TASKS.register("v_capture1", () -> TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("village", ModStats.capture_village, 1).setItemReward(() -> new ItemStack(Items.EMERALD, 10)).build());
        TASKS.register("v_capture2", () -> TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("village", ModStats.capture_village, 1).setItemReward(() -> new ItemStack(Items.EMERALD, 5)).build());
        TASKS.register("v_kill1", () -> TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("hunter", ModTags.Entities.HUNTER, 10).setItemReward(() -> new ItemStack(ModItems.human_heart.get(), 5)).build());
        TASKS.register("v_kill2", () -> TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("hunter", ModTags.Entities.ADVANCED_HUNTER, 4).setItemReward(() -> new ItemStack(ModItems.human_heart.get(), 8)).build());

        TASKS.register("h_kill1", () -> TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("vampire", ModTags.Entities.VAMPIRE, 20).setItemReward(() -> new ItemStack(Items.DIAMOND, 2)).build());
        TASKS.register("h_kill2", () -> TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("vampire", ModTags.Entities.VAMPIRE, 15).setItemReward(() -> new ItemStack(Items.DIAMOND, 2)).build());
        TASKS.register("h_kill3", () -> TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("vampire", ModTags.Entities.ADVANCED_VAMPIRE, 5).setItemReward(() -> new ItemStack(ModItems.obsidian_armor_legs_ultimate.get())).build());
        TASKS.register("h_capture1", () -> TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("village", ModStats.capture_village, 2).setItemReward(() -> new ItemStack(ModItems.vampire_blood_bottle.get(), 10)).build());
        TASKS.register("h_capture2", () -> TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("village", ModStats.capture_village, 1).setItemReward(() -> new ItemStack(ModItems.obsidian_armor_chest_ultimate.get())).build());
        TASKS.register("h_souls", () -> TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("souls", () -> new ItemStack(ModItems.soul_orb_vampire.get(), 10)).setItemReward(() -> new ItemStack(ModItems.obsidian_armor_feet_ultimate.get())).build());
        TASKS.register("h_crossbow", () -> TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("item", () -> new ItemStack(ModItems.basic_crossbow.get(), 1)).addRequirement("arrow", () -> new ItemStack(ModItems.crossbow_arrow_normal.get(), 20)).setItemReward(() -> new ItemStack(ModItems.obsidian_armor_head_ultimate.get())).build());
        TASKS.register("break_bones1", () -> TaskBuilder.builder().addRequirement("skeleton", EntityType.SKELETON, 20).setItemReward(() -> new ItemStack(Items.CHAINMAIL_CHESTPLATE)).build());
        TASKS.register("break_bones2", () -> TaskBuilder.builder().addRequirement("skeleton", EntityType.SKELETON, 14).setItemReward(() -> new ItemStack(Items.CHAINMAIL_LEGGINGS)).build());
        TASKS.register("break_bones3", () -> TaskBuilder.builder().addRequirement("skeleton", EntityType.SKELETON, 10).setItemReward(() -> new ItemStack(Items.CHAINMAIL_BOOTS)).build());
        TASKS.register("break_bones4", () -> TaskBuilder.builder().addRequirement("skeleton", EntityType.SKELETON, 10).setItemReward(() -> new ItemStack(Items.CHAINMAIL_HELMET)).build());
        TASKS.register("totem_top", () -> TaskBuilder.builder().unlockedBy(new LvlUnlocker(5)).addRequirement("obsidian", () -> new ItemStack(Items.OBSIDIAN, 32)).addRequirement("diamond", () -> new ItemStack(Items.DIAMOND, 1)).addRequirement("zombie", ModTags.Entities.ZOMBIES, 32).setItemReward(() -> new ItemStack(ModBlocks.totem_top_crafted.get())).build());

        TASKS.register("oblivion_potion_pure_blood_1", () -> TaskBuilder.builder().unlockedBy(new LvlUnlocker(1, 3)).addRequirement("poison", () -> PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", () -> new ItemStack(ModItems.pure_blood_0.get())).setItemReward(() -> new ItemStack(ModItems.oblivion_potion.get())).build());
        TASKS.register("oblivion_potion_pure_blood_2", () -> TaskBuilder.builder().unlockedBy(new LvlUnlocker(4, 6)).addRequirement("poison", () -> PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", () -> new ItemStack(ModItems.pure_blood_1.get())).setItemReward(() -> new ItemStack(ModItems.oblivion_potion.get())).build());
        TASKS.register("oblivion_potion_pure_blood_3", () -> TaskBuilder.builder().unlockedBy(new LvlUnlocker(7, 9)).addRequirement("poison", () -> PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", () -> new ItemStack(ModItems.pure_blood_2.get())).setItemReward(() -> new ItemStack(ModItems.oblivion_potion.get())).build());
        TASKS.register("oblivion_potion_pure_blood_4", () -> TaskBuilder.builder().unlockedBy(new LvlUnlocker(10, 12)).addRequirement("poison", () -> PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", () -> new ItemStack(ModItems.pure_blood_3.get())).setItemReward(() -> new ItemStack(ModItems.oblivion_potion.get())).build());
        TASKS.register("oblivion_potion_pure_blood_5", () -> TaskBuilder.builder().unlockedBy(new LvlUnlocker(13, 14)).addRequirement("poison", () -> PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", () -> new ItemStack(ModItems.pure_blood_4.get())).setItemReward(() -> new ItemStack(ModItems.oblivion_potion.get())).build());

        oblivion_potion = TASKS.register("oblivion_potion", () -> TaskBuilder.builder().addRequirement("poison", () -> PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", () -> new ItemStack(ModItems.vampire_blood_bottle.get())).setItemReward(() -> new ItemStack(ModItems.oblivion_potion.get())).build());
