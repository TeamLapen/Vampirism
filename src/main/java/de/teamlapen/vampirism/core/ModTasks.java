...
public class ModTasks {
    ...
    public static void registerTasks(IForgeRegistry<Task> registry) {
        ...
        registry.register(TaskBuilder.builder().unlockedBy(new LvlUnlocker(5)).addRequirement("obsidian", new ItemStack(Items.OBSIDIAN, 32)).addRequirement("diamond", new ItemStack(Items.DIAMOND, 1)).addRequirement("zombie", ModTags.Entities.ZOMBIES, 32).setReward(new ItemStack(ModBlocks.totem_top_crafted)).build("totem_top"));
        ...
        registry.register(TaskBuilder.builder().addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle)).setReward(new ItemStack(ModItems.oblivion_potion)).build("oblivion_potion"));
