...
public class ModTasks {
    ...
    public static void registerTasks(IForgeRegistry<Task> registry) {
        ...
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(2)).addRequirement("advanced_vampire", ModTags.Entities.ADVANCED_VAMPIRE, 8).addRequirement("gold", new ItemStack(Items.GOLD_BLOCK, 16)).setReward(new ItemStack(ModItems.hunter_minion_upgrade1)).build("hunter_minion_upgrade1"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(2)).addRequirement("advanced_vampire", ModTags.Entities.ADVANCED_VAMPIRE, 4).addRequirement("baron", ModEntities.vampire_baron, 10).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle, 20)).addRequirement("diamond", new ItemStack(Items.DIAMOND_BLOCK, 4)).setReward(new ItemStack(ModItems.hunter_minion_upgrade2)).build("hunter_minion_upgrade2"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(3)).addRequirement("advanced_vampire", ModTags.Entities.ADVANCED_VAMPIRE, 8).addRequirement("baron", ModEntities.vampire_baron, 10).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle, 20)).addRequirement("diamond", new ItemStack(Items.DIAMOND_BLOCK, 8)).setReward(new ItemStack(ModItems.hunter_minion_upgrade3)).build("hunter_minion_upgrade3"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(3)).addRequirement("baron", ModEntities.vampire_baron, 20).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle, 20)).addRequirement("book", new ItemStack(ModItems.vampire_book)).addRequirement("diamond", new ItemStack(Items.DIAMOND_BLOCK, 8)).setReward(new ItemStack(ModItems.hunter_minion_upgrade4)).build("hunter_minion_upgrade4"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(4)).addRequirement("baron", ModEntities.vampire_baron, 20).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle, 20)).addRequirement("book", new ItemStack(ModItems.vampire_book)).addRequirement("diamond", new ItemStack(Items.DIAMOND_BLOCK, 8)).setReward(new ItemStack(ModItems.hunter_minion_upgrade5)).build("hunter_minion_upgrade5"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(3)).addRequirement("baron", ModEntities.vampire_baron, 20).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle, 32)).addRequirement("book", new ItemStack(ModItems.vampire_book)).addRequirement("diamond", new ItemStack(Items.DIAMOND_BLOCK, 16)).setReward(new ItemStack(ModItems.hunter_minion_upgrade6)).build("hunter_minion_upgrade6"));
