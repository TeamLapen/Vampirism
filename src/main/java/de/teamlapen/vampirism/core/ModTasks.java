...
public class ModTasks {
    ...
    public static void registerTasks(IForgeRegistry<Task> registry) {
        //Vampire gadgets
        registry.register(vampire().unlockedBy(new LvlUnlocker(4)).addRequirement("advanced_hunter", ModTags.Entities.ADVANCED_HUNTER, 10).addRequirement("item", new ItemStack(Items.GOLD_INGOT, 5)).setReward(new ItemStack(ModItems.feeding_adapter)).build("feeding_adapter"));
        ...
        registry.register(vampire().unlockedBy(new LordLvlUnlocker(2)).addRequirement("advanced_hunter", ModTags.Entities.ADVANCED_HUNTER, 8).addRequirement("gold", new ItemStack(Items.GOLD_BLOCK, 16)).setReward(new ItemStack(ModItems.vampire_minion_upgrade_simple)).build("vampire_minion_upgrade_simple"));
        ...
        registry.register(hunter().unlockedBy(new LordLvlUnlocker(2)).addRequirement("advanced_vampire", ModTags.Entities.ADVANCED_VAMPIRE, 8).addRequirement("gold", new ItemStack(Items.GOLD_BLOCK, 16)).setReward(new ItemStack(ModItems.hunter_minion_upgrade_simple)).build("hunter_minion_upgrade_simple"));
        ...
        registry.register(vampire().unlockedBy(new LordLvlUnlocker(1, true)).addRequirement("hunter", ModTags.Entities.HUNTER, 30).addRequirement("pure_blood", new ItemStack(ModItems.pure_blood_4, 5)).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 48)).setUnique().setReward(new LordLevelReward(2)).build("vampire_lord2"));
        registry.register(vampire().unlockedBy(new LordLvlUnlocker(2, true)).addRequirement("hunter", ModTags.Entities.HUNTER, 30).addRequirement("pure_blood", new ItemStack(ModItems.pure_blood_4, 5)).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 48)).setUnique().setReward(new LordLevelReward(3)).build("vampire_lord3"));
        registry.register(vampire().unlockedBy(new LordLvlUnlocker(3, true)).addRequirement("hunter", ModTags.Entities.ADVANCED_HUNTER, 5).addRequirement("pure_blood", new ItemStack(ModItems.pure_blood_4, 10)).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 64)).setUnique().setReward(new LordLevelReward(4)).build("vampire_lord4"));
        registry.register(vampire().unlockedBy(new LordLvlUnlocker(4, true)).addRequirement("infect", ModStats.infected_creatures, 50).addRequirement("pure_blood", new ItemStack(ModItems.pure_blood_4, 20)).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 64)).addRequirement("village", ModStats.capture_village, 6).setUnique().setReward(new LordLevelReward(5)).build("vampire_lord5"));
        //Hunter Lord
        ...
        registry.register(vampire().addRequirement("hunter", ModTags.Entities.HUNTER, 10).setReward(new ItemStack(ModItems.human_heart, 5)).build("v_kill1"));
        registry.register(vampire().addRequirement("hunter", ModTags.Entities.ADVANCED_HUNTER, 4).setReward(new ItemStack(ModItems.human_heart, 8)).build("v_kill2"));
        ...
        registry.register(hunter().addRequirement("village", ModStats.capture_village, 2).setReward(new ItemStack(ModItems.vampire_blood_bottle, 10)).build("h_capture1"));
        ...
        registry.register(builder().unlockedBy(new LvlUnlocker(5)).addRequirement("obsidian", new ItemStack(Items.OBSIDIAN, 32)).addRequirement("diamond", new ItemStack(Items.DIAMOND, 1)).addRequirement("zombie", ModTags.Entities.ZOMBIES, 32).setReward(new ItemStack(ModBlocks.totem_top_crafted)).build("totem_top"));

        registry.register(builder().unlockedBy(new LvlUnlocker(1, 3)).addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.pure_blood_0)).setReward(new ItemStack(ModItems.oblivion_potion)).build("oblivion_potion_pure_blood_1"));
        registry.register(builder().unlockedBy(new LvlUnlocker(4, 6)).addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.pure_blood_1)).setReward(new ItemStack(ModItems.oblivion_potion)).build("oblivion_potion_pure_blood_2"));
        registry.register(builder().unlockedBy(new LvlUnlocker(7, 9)).addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.pure_blood_2)).setReward(new ItemStack(ModItems.oblivion_potion)).build("oblivion_potion_pure_blood_3"));
        registry.register(builder().unlockedBy(new LvlUnlocker(10, 12)).addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.pure_blood_3)).setReward(new ItemStack(ModItems.oblivion_potion)).build("oblivion_potion_pure_blood_4"));
        registry.register(builder().unlockedBy(new LvlUnlocker(13, 14)).addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.pure_blood_4)).setReward(new ItemStack(ModItems.oblivion_potion)).build("oblivion_potion_pure_blood_5"));

        registry.register(builder().addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle)).setReward(new ItemStack(ModItems.oblivion_potion)).build("oblivion_potion"));
