...
public class ModTasks {
    ...
    public static void registerTasks(IForgeRegistry<Task> registry) {
        ...
        registry.register(vampire().addRequirement("barons", ModEntities.VAMPIRE_BARON.get(), 3).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 2)).setReward(new RefinementItemReward(VReference.VAMPIRE_FACTION)).build("random_refinement2"));
