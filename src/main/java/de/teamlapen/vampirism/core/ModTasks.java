...
public class ModTasks {
    ...
    public static void registerTasks(IForgeRegistry<Task> registry) {
        //Vampire gadgets
        registry.register(TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).unlockedBy(new LvlUnlocker(4)).addRequirement("advanced_hunter", ModTags.Entities.ADVANCED_HUNTER, 10).addRequirement("item", new ItemStack(Items.GOLD_INGOT, 5)).setReward(new ItemStack(ModItems.feeding_adapter.get())).build("feeding_adapter"));
        registry.register(TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("magma", new ItemStack(Items.MAGMA_CREAM, 3)).addRequirement("hunter", ModTags.Entities.HUNTER, 10).setReward(PotionUtils.setPotion(new ItemStack(Items.POTION), ModPotions.vampire_fire_resistance)).build("fire_resistance1"));
        registry.register(TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).unlockedBy(new LvlUnlocker(7)).addRequirement("magma", new ItemStack(Items.MAGMA_CREAM, 5)).addRequirement("hunter", ModTags.Entities.HUNTER, 15).setReward(PotionUtils.setPotion(new ItemStack(Items.POTION), ModPotions.long_vampire_fire_resistance)).build("fire_resistance2"));
        ...
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(1, true)).addRequirement("vampire", ModTags.Entities.VAMPIRE, 50).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 32)).setUnique().setReward(new LordLevelReward(2)).build("hunter_lord2"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(2, true)).addRequirement("vampire", ModTags.Entities.VAMPIRE, 50).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 32)).setUnique().setReward(new LordLevelReward(3)).build("hunter_lord3"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(3, true)).addRequirement("vampire", ModTags.Entities.VAMPIRE, 75).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 64)).setUnique().setReward(new LordLevelReward(4)).build("hunter_lord4"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).unlockedBy(new LordLvlUnlocker(4, true)).addRequirement("vampire", ModTags.Entities.VAMPIRE, 100).addRequirement("gold", new ItemStack(Items.GOLD_INGOT, 64)).addRequirement("village", ModStats.capture_village, 6).setUnique().setReward(new LordLevelReward(5)).build("hunter_lord5"));
        ...
        registry.register(TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("hunter", ModTags.Entities.HUNTER, 10).setReward(new ItemStack(ModItems.human_heart.get(), 5)).build("v_kill1"));
        registry.register(TaskBuilder.builder().withFaction(VReference.VAMPIRE_FACTION).addRequirement("hunter", ModTags.Entities.ADVANCED_HUNTER, 4).setReward(new ItemStack(ModItems.human_heart.get(), 8)).build("v_kill2"));
        ...
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("vampire", ModTags.Entities.ADVANCED_VAMPIRE, 5).setReward(new ItemStack(ModItems.obsidian_armor_legs_ultimate.get())).build("h_kill3"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("village", ModStats.capture_village, 2).setReward(new ItemStack(ModItems.vampire_blood_bottle.get(), 10)).build("h_capture1"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("village", ModStats.capture_village, 1).setReward(new ItemStack(ModItems.obsidian_armor_chest_ultimate.get())).build("h_capture2"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("souls", new ItemStack(ModItems.soul_orb_vampire.get(), 10)).setReward(new ItemStack(ModItems.obsidian_armor_feet_ultimate.get())).build("h_souls"));
        registry.register(TaskBuilder.builder().withFaction(VReference.HUNTER_FACTION).addRequirement("item", new ItemStack(ModItems.basic_crossbow.get(), 1)).addRequirement("arrow", new ItemStack(ModItems.crossbow_arrow_normal.get(), 20)).setReward(new ItemStack(ModItems.obsidian_armor_head_ultimate.get())).build("h_crossbow"));
        ...
        registry.register(TaskBuilder.builder().addRequirement("poison", PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement("vampire_blood", new ItemStack(ModItems.vampire_blood_bottle.get())).setReward(new ItemStack(ModItems.oblivion_potion.get())).build("oblivion_potion"));
