...
public class ModTiles {
    ...
    public static final TileEntityType<ExtendedPotionTableTileEntity> extended_potion_table = getNull();
    ...
    static void registerTiles(IForgeRegistry<TileEntityType<?>> registry) {
        ...
        registry.register(create("extended_potion_table", ExtendedPotionTableTileEntity::new, ModBlocks.extended_potion_table));
    }
