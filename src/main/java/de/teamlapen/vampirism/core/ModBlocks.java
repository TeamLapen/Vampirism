...
public class ModBlocks {
    ...
    static void registerBlocks(IForgeRegistry<Block> registry) {
        ...
        registry.register(prepareItemRegistry(new CursedGrass(AbstractBlock.Properties.of(Material.GRASS).randomTicks().strength(0.6F).sound(SoundType.GRASS))).setRegistryName(REFERENCE.MODID, "cursed_grass"));
        ...
        Block dark_spruce_planks = new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName(REFERENCE.MODID, "dark_spruce_planks");
        Block cursed_spruce_planks = new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName(REFERENCE.MODID, "cursed_spruce_planks");
        ...
        registry.register(prepareItemRegistry(new DoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(3.0F).sound(SoundType.WOOD).noOcclusion()).setRegistryName(REFERENCE.MODID, "dark_spruce_door")));
        registry.register(prepareItemRegistry(new DoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(3.0F).sound(SoundType.WOOD).noOcclusion()).setRegistryName(REFERENCE.MODID, "cursed_spruce_door")));
        registry.register(prepareItemRegistry(new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(ModBlocks::never)).setRegistryName(REFERENCE.MODID, "dark_spruce_trapdoor")));
        registry.register(prepareItemRegistry(new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(ModBlocks::never)).setRegistryName(REFERENCE.MODID, "cursed_spruce_trapdoor")));
        ...
        registry.register(prepareItemRegistry(new LogBlock(MaterialColor.COLOR_BLACK, MaterialColor.COLOR_BLACK).setRegistryName(REFERENCE.MODID, "stripped_dark_spruce_wood")));
        registry.register(prepareItemRegistry(new LogBlock(MaterialColor.COLOR_BLACK, MaterialColor.COLOR_BLACK).setRegistryName(REFERENCE.MODID, "stripped_cursed_spruce_wood")));
        ...
        registry.register(prepareItemRegistry(new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName(REFERENCE.MODID, "dark_spruce_slab")));
        registry.register(prepareItemRegistry(new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 3.0F).sound(SoundType.WOOD)).setRegistryName(REFERENCE.MODID, "cursed_spruce_slab")));
