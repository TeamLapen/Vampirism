...
public class ModBlocks {
    ...
    public static final VampirismFlower vampirism_flower_vampire_orchid = getNull();
    ...
    static void registerItemBlocks(IForgeRegistry<Item> registry) {
        ...
        registry.register(itemBlock(castle_stairs_dark, new Item.Properties().group(VampirismMod.creativeTab)));
        registry.register(itemBlock(castle_stairs_dark_stone, new Item.Properties().group(VampirismMod.creativeTab)));
        registry.register(itemBlock(castle_stairs_purple, new Item.Properties().group(VampirismMod.creativeTab)));
    ...
    static void registerBlocks(IForgeRegistry<Block> registry) {
        ...
        BlockCastleBlock castleBlock_purple_brick = new BlockCastleBlock(BlockCastleBlock.EnumVariant.PURPLE_BRICK);
