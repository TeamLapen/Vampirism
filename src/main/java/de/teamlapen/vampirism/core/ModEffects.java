...
public class ModEffects {
    ...
    static void registerEffects(IForgeRegistry<Effect> registry) {
        ...
        registry.register(new VampirismEffect("sunscreen", EffectType.BENEFICIAL, 0xFFF100).addAttributesModifier(VReference.sunDamage, "9dc9420c-3e5e-41c7-9ba4-ff70e9dc69fc", -0.5, AttributeModifier.Operation.MULTIPLY_TOTAL));
