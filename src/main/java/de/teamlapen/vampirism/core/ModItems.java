...
public class ModItems {
    ...
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_CHEST_ENHANCED =
            ITEMS.register("armor_of_swiftness_chest_enhanced", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.CHEST, IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_CHEST_NORMAL =
            ITEMS.register("armor_of_swiftness_chest_normal", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.CHEST, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_CHEST_ULTIMATE =
            ITEMS.register("armor_of_swiftness_chest_ultimate", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.CHEST, IItemWithTier.TIER.ULTIMATE));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_FEET_ENHANCED =
            ITEMS.register("armor_of_swiftness_feet_enhanced", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.FEET, IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_FEET_NORMAL =
            ITEMS.register("armor_of_swiftness_feet_normal", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.FEET, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_FEET_ULTIMATE =
            ITEMS.register("armor_of_swiftness_feet_ultimate", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.FEET, IItemWithTier.TIER.ULTIMATE));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_HEAD_ENHANCED =
            ITEMS.register("armor_of_swiftness_head_enhanced", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.HEAD, IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_HEAD_NORMAL =
            ITEMS.register("armor_of_swiftness_head_normal", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.HEAD, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_HEAD_ULTIMATE =
            ITEMS.register("armor_of_swiftness_head_ultimate", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.HEAD, IItemWithTier.TIER.ULTIMATE));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_LEGS_ENHANCED =
            ITEMS.register("armor_of_swiftness_legs_enhanced", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.LEGS, IItemWithTier.TIER.ULTIMATE));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_LEGS_NORMAL =
            ITEMS.register("armor_of_swiftness_legs_normal", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.LEGS, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<ArmorOfSwiftnessItem> ARMOR_OF_SWIFTNESS_LEGS_ULTIMATE =
            ITEMS.register("armor_of_swiftness_legs_ultimate", () -> new ArmorOfSwiftnessItem(EquipmentSlotType.LEGS, IItemWithTier.TIER.ULTIMATE));

    public static final RegistryObject<SimpleCrossbowItem> BASIC_CROSSBOW =
            ITEMS.register("basic_crossbow", () -> new SimpleCrossbowItem(1,20,300, ItemTier.WOOD));
    public static final RegistryObject<DoubleCrossbowItem> BASIC_DOUBLE_CROSSBOW =
            ITEMS.register("basic_double_crossbow", () -> new DoubleCrossbowItem(1,20,300, ItemTier.WOOD));
    public static final RegistryObject<TechCrossbowItem> BASIC_TECH_CROSSBOW =
            ITEMS.register("basic_tech_crossbow", () -> new TechCrossbowItem(1.6F, 6, 300, ItemTier.DIAMOND));
    ...
    public static final RegistryObject<BucketItem> BLOOD_BUCKET =
            ITEMS.register("blood_bucket", () -> new BucketItem(ModFluids.BLOOD, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(ItemGroup.TAB_MISC)));
    ...
    public static final RegistryObject<SimpleCrossbowItem> ENHANCED_CROSSBOW =
            ITEMS.register("enhanced_crossbow", () -> new SimpleCrossbowItem(1.5F, 15, 250, ItemTier.IRON));
    public static final RegistryObject<DoubleCrossbowItem> ENHANCED_DOUBLE_CROSSBOW =
            ITEMS.register("enhanced_double_crossbow", () -> new DoubleCrossbowItem(1.5F, 15, 350, ItemTier.IRON));
    public static final RegistryObject<TechCrossbowItem> ENHANCED_TECH_CROSSBOW =
            ITEMS.register("enhanced_tech_crossbow", () -> new TechCrossbowItem(1.7F, 4, 450, ItemTier.DIAMOND));

    public static final RegistryObject<Item> GARLIC_BEACON_CORE =
            ITEMS.register("garlic_beacon_core", () -> new Item(creativeTabProps()));
    public static final RegistryObject<Item> GARLIC_BEACON_CORE_IMPROVED =
            ITEMS.register("garlic_beacon_core_improved", () -> new Item(creativeTabProps()));
    ...
    public static final RegistryObject<Item> HOLY_SALT_WATER =
            ITEMS.register("holy_salt_water", () -> new Item(new Item.Properties().stacksTo(1)) {
                @Override
    ...
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_CHEST_ENHANCED =
            ITEMS.register("hunter_coat_chest_enhanced", () -> new HunterCoatItem(EquipmentSlotType.CHEST, IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_CHEST_NORMAL =
            ITEMS.register("hunter_coat_chest_normal", () -> new HunterCoatItem(EquipmentSlotType.CHEST, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_CHEST_ULTIMATE =
            ITEMS.register("hunter_coat_chest_ultimate", () -> new HunterCoatItem(EquipmentSlotType.CHEST, IItemWithTier.TIER.ULTIMATE));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_FEET_ENHANCED =
            ITEMS.register("hunter_coat_feet_enhanced", () -> new HunterCoatItem(EquipmentSlotType.FEET, IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_FEET_NORMAL =
            ITEMS.register("hunter_coat_feet_normal", () -> new HunterCoatItem(EquipmentSlotType.FEET, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_FEET_ULTIMATE =
            ITEMS.register("hunter_coat_feet_ultimate", () -> new HunterCoatItem(EquipmentSlotType.FEET, IItemWithTier.TIER.ULTIMATE));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_HEAD_ENHANCED =
            ITEMS.register("hunter_coat_head_enhanced", () -> new HunterCoatItem(EquipmentSlotType.HEAD, IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_HEAD_NORMAL =
            ITEMS.register("hunter_coat_head_normal", () -> new HunterCoatItem(EquipmentSlotType.HEAD, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_HEAD_ULTIMATE =
            ITEMS.register("hunter_coat_head_ultimate", () -> new HunterCoatItem(EquipmentSlotType.HEAD, IItemWithTier.TIER.ULTIMATE));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_LEGS_ENHANCED =
            ITEMS.register("hunter_coat_legs_enhanced", () -> new HunterCoatItem(EquipmentSlotType.LEGS, IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_LEGS_NORMAL =
            ITEMS.register("hunter_coat_legs_normal", () -> new HunterCoatItem(EquipmentSlotType.LEGS, IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<HunterCoatItem> HUNTER_COAT_LEGS_ULTIMATE =
            ITEMS.register("hunter_coat_legs_ultimate", () -> new HunterCoatItem(EquipmentSlotType.LEGS, IItemWithTier.TIER.ULTIMATE));
    ...
    public static final RegistryObject<VampirismItemBloodFood> HUMAN_HEART =
            ITEMS.register("human_heart", () -> new VampirismItemBloodFood((new Food.Builder()).nutrition(20).saturationMod(1.5F).build(), new Food.Builder().nutrition(5).saturationMod(1f).build()));
    ...
    public static final RegistryObject<BucketItem> IMPURE_BLOOD_BUCKET =
            ITEMS.register("impure_blood_bucket", () -> new BucketItem(ModFluids.IMPURE_BLOOD, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(ItemGroup.TAB_MISC)));
    ...
    public static final RegistryObject<ColoredVampireClothingItem> VAMPIRE_CLOAK_BLACK_BLUE =
            ITEMS.register("vampire_cloak_black_blue", () -> new ColoredVampireClothingItem(EquipmentSlotType.CHEST, ColoredVampireClothingItem.EnumModel.CLOAK, "vampire_cloak", ColoredVampireClothingItem.EnumClothingColor.BLACKBLUE));
    public static final RegistryObject<ColoredVampireClothingItem> VAMPIRE_CLOAK_BLACK_RED =
            ITEMS.register("vampire_cloak_black_red", () -> new ColoredVampireClothingItem(EquipmentSlotType.CHEST, ColoredVampireClothingItem.EnumModel.CLOAK, "vampire_cloak", ColoredVampireClothingItem.EnumClothingColor.BLACKRED));
    public static final RegistryObject<ColoredVampireClothingItem> VAMPIRE_CLOAK_BLACK_WHITE =
            ITEMS.register("vampire_cloak_black_white", () -> new ColoredVampireClothingItem(EquipmentSlotType.CHEST, ColoredVampireClothingItem.EnumModel.CLOAK, "vampire_cloak", ColoredVampireClothingItem.EnumClothingColor.BLACKWHITE));
    public static final RegistryObject<ColoredVampireClothingItem> VAMPIRE_CLOAK_RED_BLACK =
            ITEMS.register("vampire_cloak_red_black", () -> new ColoredVampireClothingItem(EquipmentSlotType.CHEST, ColoredVampireClothingItem.EnumModel.CLOAK, "vampire_cloak", ColoredVampireClothingItem.EnumClothingColor.REDBLACK));
    public static final RegistryObject<ColoredVampireClothingItem> VAMPIRE_CLOAK_WHITE_BLACK =
            ITEMS.register("vampire_cloak_white_black", () -> new ColoredVampireClothingItem(EquipmentSlotType.CHEST, ColoredVampireClothingItem.EnumModel.CLOAK, "vampire_cloak", ColoredVampireClothingItem.EnumClothingColor.WHITEBLACK));
    ...
    public static final RegistryObject<VampirismItemBloodFood> WEAK_HUMAN_HEART =
            ITEMS.register("weak_human_heart", () -> new VampirismItemBloodFood((new Food.Builder()).nutrition(10).saturationMod(0.9F).build(), new Food.Builder().nutrition(3).saturationMod(1f).build()));


    public static final RegistryObject<SpawnEggItem> VAMPIRE_SPAWN_EGG =
            ITEMS.register("vampire_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.VAMPIRE, 0x8B15A3, 0xa735e3, new Item.Properties().tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<SpawnEggItem> VAMPIRE_HUNTER_SPAWN_EGG =
            ITEMS.register("vampire_hunter_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.HUNTER, 0x2d05f2, 0x2600e0, new Item.Properties().tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<SpawnEggItem> ADVANCED_VAMPIRE_SPAWN_EGG =
            ITEMS.register("advanced_vampire_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.ADVANCED_VAMPIRE, 0x8B15A3, 0x560a7e, new Item.Properties().tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<SpawnEggItem> ADVANCED_VAMPIRE_HUNTER_SPAWN_EGG =
            ITEMS.register("advanced_vampire_hunter_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.ADVANCED_HUNTER, 0x2d05f2, 0x1a028c, new Item.Properties().tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<SpawnEggItem> VAMPIRE_BARON_SPAWN_EGG =
            ITEMS.register("vampire_baron_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.VAMPIRE_BARON, 0x8B15A3, 0x15acda, new Item.Properties().tab(ItemGroup.TAB_MISC)));
    public static final RegistryObject<SpawnEggItem> HUNTER_TRAINER_SPAWN_EGG =
            ITEMS.register("hunter_trainer_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.HUNTER_TRAINER, 0x2d05f2, 0x1cdb49, new Item.Properties().tab(ItemGroup.TAB_MISC)));
    ...
    public static final RegistryObject<MinionUpgradeItem> VAMPIRE_MINION_UPGRADE_SPECIAL =
            ITEMS.register("vampire_minion_upgrade_special", () -> new MinionUpgradeItem(5,6, VReference.VAMPIRE_FACTION));
    ...
    public static final RegistryObject<VampireClothingItem> VAMPIRE_CLOTHING_CROWN =
            ITEMS.register("vampire_clothing_crown", () -> new VampireClothingItem(EquipmentSlotType.HEAD));
    public static final RegistryObject<VampireClothingItem> VAMPIRE_CLOTHING_LEGS =
            ITEMS.register("vampire_clothing_legs", () -> new VampireClothingItem(EquipmentSlotType.LEGS));
    public static final RegistryObject<VampireClothingItem> VAMPIRE_CLOTHING_BOOTS =
            ITEMS.register("vampire_clothing_boots", () -> new VampireClothingItem(EquipmentSlotType.FEET));
    public static final RegistryObject<VampireClothingItem> VAMPIRE_CLOTHING_HAT =
            ITEMS.register("vampire_clothing_hat", () -> new VampireClothingItem(EquipmentSlotType.HEAD));
    ...
    public static final RegistryObject<WallOrFloorItem> ITEM_CANDELABRA =
            ITEMS.register("item_candelabra", () -> new WallOrFloorItem(ModBlocks.CANDELABRA.get(), ModBlocks.CANDELABRA_WALL.get(), new Item.Properties().tab(VampirismMod.creativeTab)));
    public static final RegistryObject<SignItem> DARK_SPRUCE_SIGN =
            ITEMS.register("dark_spruce_sign", () -> new SignItem((new Item.Properties()).stacksTo(16).tab(ItemGroup.TAB_DECORATIONS), ModBlocks.DARK_SPRUCE_SIGN.get(), ModBlocks.DARK_SPRUCE_WALL_SIGN.get()));
    public static final RegistryObject<SignItem> CURSED_SPRUCE_SIGN =
            ITEMS.register("cursed_spruce_sign", () -> new SignItem((new Item.Properties()).stacksTo(16).tab(ItemGroup.TAB_DECORATIONS), ModBlocks.CURSED_SPRUCE_SIGN.get(), ModBlocks.CURSED_SPRUCE_WALL_SIGN.get()));

    public static final RegistryObject<CrucifixItem> CRUCIFIX_NORMAL =
            ITEMS.register("crucifix_normal", () -> new CrucifixItem(IItemWithTier.TIER.NORMAL));
    public static final RegistryObject<CrucifixItem> CRUCIFIX_ENHANCED =
            ITEMS.register("crucifix_enhanced", () -> new CrucifixItem(IItemWithTier.TIER.ENHANCED));
    public static final RegistryObject<CrucifixItem> CRUCIFIX_ULTIMATE =
            ITEMS.register("crucifix_ultimate", () -> new CrucifixItem(IItemWithTier.TIER.ULTIMATE));

    public static final RegistryObject<VampirismBoatItem> DARK_SPRUCE_BOAT =
            ITEMS.register("dark_spruce_boat", () -> new VampirismBoatItem(VampirismBoatItem.BoatType.DARK_SPRUCE, creativeTabProps().stacksTo(1)));
    public static final RegistryObject<VampirismBoatItem> CURSED_SPRUCE_BOAT =
            ITEMS.register("cursed_spruce_boat", () -> new VampirismBoatItem(VampirismBoatItem.BoatType.CURSED_SPRUCE, creativeTabProps().stacksTo(1)));
