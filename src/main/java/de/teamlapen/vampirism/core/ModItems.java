...
public class ModItems {
    ...
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_WHITE = register("vampire_cloak_white", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_ORANGE = register("vampire_cloak_orange", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_MAGENTA = register("vampire_cloak_magenta", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_LIGHT_BLUE = register("vampire_cloak_light_blue", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_YELLOW = register("vampire_cloak_yellow", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_LIME = register("vampire_cloak_lime", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_PINK = register("vampire_cloak_pink", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_GRAY = register("vampire_cloak_gray", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_LIGHT_GRAY = register("vampire_cloak_light_gray", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_CYAN = register("vampire_cloak_cyan", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_PURPLE = register("vampire_cloak_purple", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_BLUE = register("vampire_cloak_blue", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_BROWN = register("vampire_cloak_brown", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_GREEN = register("vampire_cloak_green", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_RED = register("vampire_cloak_red", VampireCloakItem::new);
    public static final DeferredItem<VampireCloakItem> VAMPIRE_CLOAK_BLACK = register("vampire_cloak_black", VampireCloakItem::new);
