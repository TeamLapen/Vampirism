...
public class ModItems {
    ...
    private static void registerCraftingRecipes() {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(Items.GLASS_BOTTLE), new ItemStack(bloodBottle, 1, OreDictionary.WILDCARD_VALUE));
    ...
    public static boolean fixMapping(FMLMissingMappingsEvent.MissingMapping mapping){
        ...
        if(!r)r=checkMapping(mapping,converted,enhancedTechCrossbow,humanHeart,humanHeartWeak,hunterAxe,hunterCoat_boots,hunterCoat_chest,hunterCoat_helmet,hunterCoat_legs,hunterHat0,hunterHat1,hunterIntel,injection,itemAlchemicalFire,itemCoffin,itemGarlic,itemMedChair);
        if(!r)r=checkMapping(mapping,converted,itemTent,obsidianArmor_boots,obsidianArmor_chest,obsidianArmor_helmet,obsidianArmor_legs,pitchfork,pureBlood,techCrossbowAmmoPackage,vampireBlood,vampireBook,vampireFang);
        return r;
    }
