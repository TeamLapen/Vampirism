...
public class ModAttributes {
    ...
    static void registerAttributes(IForgeRegistry<Attribute> registry) {
        ...
        registry.register(new RangedAttribute("vampirism.blood_exhaustion", 1.0, 0.0, 10).func_233753_a_(true)/*shouldWatch*/.setRegistryName(REFERENCE.MODID, "blood_exhaustion"));
