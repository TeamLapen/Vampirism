...
public class ModPotions {
    ...
    public static void registerPotions(IForgeRegistry<Potion> registry) {
        registry.register(new HunterPotion("very_long_slow_falling", "slow_falling", new MobEffectInstance(MobEffects.SLOW_FALLING, 48000)));
        registry.register(new HunterPotion("long_luck", "luck", new MobEffectInstance(MobEffects.LUCK, 60000)));
        registry.register(new HunterPotion("very_long_weakness", "weakness", new MobEffectInstance(MobEffects.WEAKNESS, 48000)));
        registry.register(new HunterPotion("very_strong_strength", "strength", new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 2)));
        registry.register(new HunterPotion("very_long_strength", "strength", new MobEffectInstance(MobEffects.DAMAGE_BOOST, 96000)));
        registry.register(new HunterPotion("long_strong_strength", "strength", new MobEffectInstance(MobEffects.DAMAGE_BOOST, 4800, 1)));
        registry.register(new HunterPotion("very_strong_regeneration", "regeneration", new MobEffectInstance(MobEffects.REGENERATION, 450, 2)));
        registry.register(new HunterPotion("very_long_regeneration", "regeneration", new MobEffectInstance(MobEffects.REGENERATION, 18000)));
        registry.register(new HunterPotion("long_strong_regeneration", "regeneration", new MobEffectInstance(MobEffects.REGENERATION, 1200, 1)));
        registry.register(new HunterPotion("very_strong_poison", "poison", new MobEffectInstance(MobEffects.POISON, 432, 2)));
        registry.register(new HunterPotion("long_strong_poison", "poison", new MobEffectInstance(MobEffects.POISON, 1200, 1)));
        registry.register(new HunterPotion("very_long_poison", "poison", new MobEffectInstance(MobEffects.POISON, 18000)));
        registry.register(new HunterPotion("very_strong_harming", "harming", new MobEffectInstance(MobEffects.HARM, 1, 2)));
        registry.register(new HunterPotion("very_strong_healing", "healing", new MobEffectInstance(MobEffects.HEAL, 1, 2)));
        registry.register(new HunterPotion("very_long_water_breathing", "water_breathing", new MobEffectInstance(MobEffects.WATER_BREATHING, 96000)));
        registry.register(new HunterPotion("very_strong_slowness", "slowness", new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 400, 5)));
        registry.register(new HunterPotion("very_long_slowness", "slowness", new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 48000)));
        registry.register(new HunterPotion("long_strong_slowness", "slowness", new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 4800, 3)));
        registry.register(new HunterPotion("very_strong_swiftness", "swiftness", new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 1200, 2)));
        registry.register(new HunterPotion("very_long_swiftness", "swiftness", new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 48000)));
        registry.register(new HunterPotion("long_strong_swiftness", "swiftness", new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 4800, 1)));
        registry.register(new HunterPotion("very_long_fire_resistance", "fire_resistance", new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 96000)));
        registry.register(new HunterPotion("very_strong_leaping", "leaping", new MobEffectInstance(MobEffects.JUMP, 1800, 2)));
        registry.register(new HunterPotion("very_long_leaping", "leaping", new MobEffectInstance(MobEffects.JUMP, 96000)));
        registry.register(new HunterPotion("long_strong_leaping", "leaping", new MobEffectInstance(MobEffects.JUMP, 9600, 1)));
        registry.register(new HunterPotion("very_long_invisibility", "invisibility", new MobEffectInstance(MobEffects.INVISIBILITY, 96000)));
        registry.register(new HunterPotion("very_long_night_vision", "night_vision", new MobEffectInstance(MobEffects.NIGHT_VISION, 96000)));
        registry.register(new HunterPotion("nausea", null, new MobEffectInstance(MobEffects.CONFUSION, 1200)));
        registry.register(new HunterPotion("long_nausea", "nausea", new MobEffectInstance(MobEffects.CONFUSION, 2400)));
        registry.register(new HunterPotion("very_long_nausea", "nausea", new MobEffectInstance(MobEffects.CONFUSION, 24000)));
        registry.register(new HunterPotion("thirst", null, new MobEffectInstance(ModEffects.thirst.get(), 1200)));
        registry.register(new HunterPotion("long_thirst", "thirst", new MobEffectInstance(ModEffects.thirst.get(), 4800)));
        registry.register(new HunterPotion("strong_thirst", "thirst", new MobEffectInstance(ModEffects.thirst.get(), 400, 1)));
        registry.register(new HunterPotion("very_long_thirst", "thirst", new MobEffectInstance(ModEffects.thirst.get(), 24000)));
        registry.register(new HunterPotion("very_strong_thirst", "thirst", new MobEffectInstance(ModEffects.thirst.get(), 1200, 2)));
        registry.register(new HunterPotion("long_strong_thirst", "thirst", new MobEffectInstance(ModEffects.thirst.get(), 9600, 1)));
        registry.register(new HunterPotion("blindness", null, new MobEffectInstance(MobEffects.BLINDNESS, 1200)));
        registry.register(new HunterPotion("long_blindness", "blindness", new MobEffectInstance(MobEffects.BLINDNESS, 4800)));
        registry.register(new HunterPotion("very_long_blindness", "blindness", new MobEffectInstance(MobEffects.BLINDNESS, 24000)));
        registry.register(new HunterPotion("health_boost", null, new MobEffectInstance(MobEffects.HEALTH_BOOST, 1200)));
        registry.register(new HunterPotion("long_health_boost", "health_boost", new MobEffectInstance(MobEffects.HEALTH_BOOST, 4800)));
        registry.register(new HunterPotion("strong_health_boost", "health_boost", new MobEffectInstance(MobEffects.HEALTH_BOOST, 400, 1)));
        registry.register(new HunterPotion("very_long_health_boost", "health_boost", new MobEffectInstance(MobEffects.HEALTH_BOOST, 48000)));
        registry.register(new HunterPotion("very_strong_health_boost", "health_boost", new MobEffectInstance(MobEffects.HEALTH_BOOST, 400, 2)));
        registry.register(new HunterPotion("long_strong_health_boost", "health_boost", new MobEffectInstance(MobEffects.HEALTH_BOOST, 1200, 1)));
        registry.register(new HunterPotion("resistance", null, new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1800)));
        registry.register(new HunterPotion("long_resistance", "resistance", new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 4800)));
        registry.register(new HunterPotion("strong_resistance", "resistance", new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 400, 1)));

        //Vampire
        registry.register(new VampirismPotion("vampire_fire_resistance", null, new MobEffectInstance(ModEffects.fire_protection.get(), 3600, 5)));
        registry.register(new VampirismPotion("long_vampire_fire_resistance", "vampire_fire_resistance", new MobEffectInstance(ModEffects.fire_protection.get(), 9600, 5)));
    }
