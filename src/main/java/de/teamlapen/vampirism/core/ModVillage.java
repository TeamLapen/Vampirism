...
public class ModVillage {
    ...
    public static final RegistryObject<PointOfInterestType> CHURCH_ALTAR = POI_TYPES.register("church_altar", () -> (FactionPointOfInterestType) PointOfInterestType.registerBlockStates(new FactionPointOfInterestType("no_faction", getAllStates(ModBlocks.CHURCH_ALTAR.get()), 1, 1)));
    ...
    public static final RegistryObject<VillagerProfession> PRIEST = PROFESSIONS.register("priest", () -> new VillagerProfession("priest", CHURCH_ALTAR.get(), ImmutableSet.of(), ImmutableSet.of(), ModSounds.BLESSING_MUSIC.get()));
    ...
    private static Map<Integer, VillagerTrades.ITrade[]> getPriestTrades() {
        return ImmutableMap.of(
                1, new VillagerTrades.ITrade[]{
                        new VillagerTrades.EmeraldForItemsTrade(ModItems.PURE_SALT.get(), 25, 1, 4),
                        new VillagerTrades.EmeraldForItemsTrade(ModItems.PURE_SALT_WATER.get(), 25, 1, 4),
                        new VillagerTrades.EmeraldForItemsTrade(ModItems.ITEM_GARLIC.get(), 30, 4, 2),
                ...
                4, new VillagerTrades.ITrade[]{
                        new VillagerTrades.ItemsForEmeraldsTrade(ModItems.HOLY_WATER_BOTTLE_ULTIMATE.get(), 1, 4, 4),

                },
                5, new VillagerTrades.ITrade[]{
                        new VillagerTrades.ItemsForEmeraldsTrade(ModItems.HOLY_WATER_BOTTLE_ENHANCED.get(), 3, 4, 4),
