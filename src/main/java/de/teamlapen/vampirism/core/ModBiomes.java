...
public class ModBiomes {
    ...
    static void registerBiomes(IForgeRegistry<Biome> registry) {
        registry.register(new VampireForestBiome(new ResourceLocation(REFERENCE.MODID, "vampire_forest"), builder -> builder));
        registry.register(new VampireForestBiome(new ResourceLocation(REFERENCE.MODID, "vampire_forest_hills"), builder -> builder.depth(0.1f).scale(0.6f)));
    }
    ...
    static void addBiome() {
        ...
        BiomeDictionary.addTypes(vampire_forest_hills, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.MAGICAL, BiomeDictionary.Type.SPOOKY, BiomeDictionary.Type.HILLS);
        if (!VampirismConfig.SERVER.disableVampireForest.get()) {
            ...
            BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(vampire_forest_hills, VampirismConfig.BALANCE.vampireForestWeight.get()));
        }
    }
