...
public class Achievements {
    ...
    public static Achievement suckingBlood = new Achievement("achievement.sucking_blood", REFERENCE.MODID + ".sucking_blood", 1, 2, (ItemStack) new ItemStack(ModItems.bloodBottle, 1, ItemBloodBottle.AMOUNT), becomingAVampire);
