...
public class Achievements {
    public static Achievement becomingAVampire = new Achievement("achievement.becoming_vampire", REFERENCE.MODID + ".becoming_vampire", 0, 0, (Item) null, null);//TODO change item to vampire fang
