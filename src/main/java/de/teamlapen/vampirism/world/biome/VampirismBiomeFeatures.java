...
public class VampirismBiomeFeatures {
    ...
    public static final Holder<ConfiguredFeature<RandomFeatureConfiguration, ?>> vampire_trees = FeatureUtils.register("vampire_trees_placed", Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(vampire_tree_red_placed, 0.3f)), vampire_tree_placed));
