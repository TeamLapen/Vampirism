...
public class VampirismBiomeFeatures {
    ...
    public static final PlacedFeature vampire_dungeon_placed = PlacementUtils.register("vampirism:vampire_dungeon", vampire_dungeon.placed(CountPlacement.of(3), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.top()), BiomeFilter.biome()));
    public static final PlacedFeature vampire_flower_placed = PlacementUtils.register("vampirism:vampire_flower", vampire_flower.placed(RarityFilter.onAverageOnceEvery(5), PlacementUtils.HEIGHTMAP, InSquarePlacement.spread(), BiomeFilter.biome()));
