...
public class AdjustableLevelCondition implements LootCondition {
    ...
    public static class Serializer extends LootCondition.Serializer<AdjustableLevelCondition> {
