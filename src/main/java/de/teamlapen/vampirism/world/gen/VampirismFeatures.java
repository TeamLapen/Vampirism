...
public class VampirismFeatures {
    ...
    public static final RegistryObject<PlacedFeature> vampire_tree_placed = PLACED_FEATURES.register("vampire_tree_placed", () -> new PlacedFeature(getHolder(vampire_tree), List.of(PlacementUtils.filteredByBlockSurvival((ModBlocks.vampire_spruce_sapling)))));
    ...
    public static final RegistryObject<PlacedFeature> vampire_tree_red_placed = PLACED_FEATURES.register("vampire_tree_red_placed", () -> new PlacedFeature(getHolder(vampire_tree_red), List.of(PlacementUtils.filteredByBlockSurvival((ModBlocks.bloody_spruce_sapling)))));
