...
public class BadlandsHunterOutpostPools {
    ...
    public static final ResourceKey<StructureTemplatePool> START = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate"));
    public static final ResourceKey<StructureTemplatePool> PLATE1_SIDE1 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_1/side_1"));
    public static final ResourceKey<StructureTemplatePool> PLATE1_SIDE2 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_1/side_2"));
    public static final ResourceKey<StructureTemplatePool> PLATE1_SIDE3 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_1/side_3"));
    public static final ResourceKey<StructureTemplatePool> PLATE1_SIDE4 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_1/side_4"));
    public static final ResourceKey<StructureTemplatePool> PLATE2_SIDE1 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_2/side_1"));
    public static final ResourceKey<StructureTemplatePool> PLATE2_SIDE2 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_2/side_2"));
    public static final ResourceKey<StructureTemplatePool> PLATE2_SIDE3 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_2/side_3"));
    public static final ResourceKey<StructureTemplatePool> PLATE2_SIDE4 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_2/side_4"));
    public static final ResourceKey<StructureTemplatePool> PLATE3_SIDE1 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_3/side_1"));
    public static final ResourceKey<StructureTemplatePool> PLATE3_SIDE2 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_3/side_2"));
    public static final ResourceKey<StructureTemplatePool> PLATE3_SIDE3 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_3/side_3"));
    public static final ResourceKey<StructureTemplatePool> PLATE3_SIDE4 = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/plate/plate_3/side_4"));
    public static final ResourceKey<StructureTemplatePool> WALL_STRAIGHT = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/wall/straight"));
    public static final ResourceKey<StructureTemplatePool> WALL_STRAIGHT_LONG = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/wall/straight_long"));
    public static final ResourceKey<StructureTemplatePool> WALL_CORNER = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/wall/corner"));
    public static final ResourceKey<StructureTemplatePool> WALL_GATE = ResourceKey.create(Registries.TEMPLATE_POOL, new ResourceLocation(REFERENCE.MODID, "hunter_outpost/badlands/wall/gate"));
