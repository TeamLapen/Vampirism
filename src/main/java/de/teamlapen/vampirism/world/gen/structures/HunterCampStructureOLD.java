/*package de.teamlapen.vampirism.world.old.gen.structure;
...
public class HunterCampStructureOLD extends ScatteredStructure<NoFeatureConfig> { //TODO keep for reference
    ...
    private static final Logger LOGGER = LogManager.getLogger(HunterCampStructureOLD.class);
    private BlockState campfire_blockstate;


    public HunterCampStructureOLD(Function<Dynamic<?>, ? extends NoFeatureConfig> function) {
        super(function);
    ...
    public IStartFactory getStartFactory() {
        return HunterCampStructureOLD.Start::new;
    }
 ...
 *//*
    ...
    boolean canCampSpawnAt(World world, Biome biome, int chunkX, int chunkZ) { //TODO 1.13 why isn't this used anymore
        ...
        //Check Biome
        if (ModBiomes.vampire_forest.getRegistryName().equals(biome.getRegistryName())) {
            return false;
        }
