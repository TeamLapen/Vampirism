...
public class MotherPiece extends ScatteredFeaturePiece {
    ...
    protected void placeRoots(@NotNull WorldGenLevel level, @NotNull BoundingBox box, @NotNull RandomSource random) {
        ...
        BlockState state1 = ModBlocks.CURSED_SPRUCE_WOOD.get().activeBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Y);
        BlockState state2 = ModBlocks.CURSED_SPRUCE_WOOD.get().activeBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z);
        BlockState state3 = ModBlocks.CURSED_SPRUCE_WOOD.get().activeBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X);
        BlockState state4 = ModBlocks.CURSED_SPRUCE_LOG.get().activeBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Y);
