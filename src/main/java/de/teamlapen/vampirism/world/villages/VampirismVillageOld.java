 ...
 */
public class VampirismVillageOld implements IVampirismVillageOLD {


    @CapabilityInject(IVampirismVillageOLD.class)
    public final static Capability<IVampirismVillageOLD> CAP = null;

    public static VampirismVillageOld get(Village v) {
        return (VampirismVillageOld) v.getCapability(CAP, null);
    }

    public static void registerCapability() {
        CapabilityManager.INSTANCE.register(IVampirismVillageOLD.class, new VampirismVillageOld.Storage(), VampirismVillageDefaultImplOLD.class);
    }
    ...
    public static ICapabilityProvider createNewCapability(final Village village) {
        return new ICapabilitySerializable<NBTTagCompound>() {
            ...
            IVampirismVillageOLD inst = new VampirismVillageOld(village);
    ...
    public VampirismVillageOld(@Nonnull Village village) {
    ...
    private static class Storage implements Capability.IStorage<IVampirismVillageOLD> {
        ...
        @Override
        public void readNBT(Capability<IVampirismVillageOLD> capability, IVampirismVillageOLD instance, EnumFacing side, NBTBase nbt) {
            ((VampirismVillageOld) instance).readFromNBT((NBTTagCompound) nbt);
        }

        @Override
        public NBTBase writeNBT(Capability<IVampirismVillageOLD> capability, IVampirismVillageOLD instance, EnumFacing side) {
            NBTTagCompound nbt = new NBTTagCompound();
            ((VampirismVillageOld) instance).writeToNBT(nbt);
            return nbt;
        }
    }
