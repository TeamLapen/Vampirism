...
public class BiomeGenVampireForest extends VampirismBiome {
    ...
    public BiomeGenVampireForest() {
        super(new BiomeBuilder().surfaceBuilder(new CompositeSurfaceBuilder<>(Biome.DEFAULT_SURFACE_BUILDER, VAMPIRE_SURFACE)).category(Category.FOREST).depth(0.1F).scale(0.025F).waterColor(0xEE2505).waterFogColor(0xEE2505).precipitation(RainType.NONE).parent(null).downfall(0).temperature(0.3f));
