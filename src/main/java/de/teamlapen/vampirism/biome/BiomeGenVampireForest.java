...
public class BiomeGenVampireForest extends VampirismBiome {
    ...
    public BiomeGenVampireForest() {
        super(new BiomeBuilder().surfaceBuilder(new CompositeSurfaceBuilder<>(Biome.DEFAULT_SURFACE_BUILDER, VAMPIRE_SURFACE)).precipitation(Biome.RainType.NONE).category(Category.FOREST).depth(0.1F).scale(0.025F).temperature(0.2F).waterColor(0xEE2505).waterFogColor(0xEE2505).precipitation(RainType.NONE).parent((String) null).downfall(0.0F));//TODO modify downfall,temperature
