...
public class VampirePlayer extends VampirismPlayer<IVampirePlayer> implements IVampirePlayer {
    ...
    public int onBite(IVampire biter) {
        ...
        if (getLevel() == 0) {
            ...
            if (!player.isPotionActive(ModPotions.sanguinare) && (!(biter instanceof IVampirePlayer) || Permissions
                    .canPlayerTurnPlayer(((IVampirePlayer) biter).getRepresentingPlayer())) && Helper.canBecomeVampire(player))
            {
