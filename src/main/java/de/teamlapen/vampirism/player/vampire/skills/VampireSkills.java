...
public class VampireSkills {
    ...
    public static final ISkill fledgling = getNull();
    ...
    public static void registerVampireSkills(IForgeRegistry<ISkill> registry) {
        ...
        registry.register(new ActionSkill<>("dark_blood_projectile", VampireActions.DARK_BLOOD_PROJECTILE.get(), true));
        registry.register(new ActionSkill<>("freeze", VampireActions.FREEZE.get(), true));
        registry.register(new ActionSkill<>("half_invulnerable", VampireActions.HALF_INVULNERABLE.get(), true));
        ...
        registry.register(new ActionSkill<>("sunscreen", VampireActions.SUNSCREEN.get(), true));
        registry.register(new ActionSkill<>("summon_bats", VampireActions.SUMMON_BAT.get(), true));
        ...
        registry.register(new ActionSkill<>("teleport", VampireActions.TELEPORT.get(), true));
        registry.register(new ActionSkill<>("vampire_disguise", VampireActions.DISGUISE_VAMPIRE.get(), true));
        registry.register(new ActionSkill<>("vampire_invisibility", VampireActions.VAMPIRE_INVISIBILITY.get()));
        ...
        registry.register(new ActionSkill<>("vampire_rage", VampireActions.VAMPIRE_RAGE.get(), true));
        registry.register(new ActionSkill<>("vampire_regeneration", VampireActions.REGEN.get(), true));
        ...
        registry.register(new ActionSkill<>("hissing", VampireActions.HISSING.get(), true));
    }
    ...
    public static void fixMappings(RegistryEvent.MissingMappings<ISkill> event) {
        event.getAllMappings().forEach(missingMapping -> {
            if ("vampirism:creeper_avoided".equals(missingMapping.key.toString())) {
                ...
                missingMapping.remap(fledgling);
            }
        });
    }
}
