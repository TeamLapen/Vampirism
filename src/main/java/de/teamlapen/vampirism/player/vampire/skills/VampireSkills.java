...
public class VampireSkills {
    ...
    public static void registerVampireSkills(IForgeRegistry<ISkill> registry) {
        ...
        registry.register(new VampirismSkill.SimpleVampireSkill("vampire_jump", false).setToggleActions(player -> ((VampirePlayer) player).getSpecialAttributes().setJumpBoost(VampirismConfig.BALANCE.vsJumpBoost.get() + 1), player -> ((VampirePlayer) player).getSpecialAttributes().setJumpBoost(0)).setTranslationKey("effect.minecraft.jump_boost"));
        ...
        registry.register(new VampirismSkill.SimpleVampireSkill("vampire_speed", false).setTranslationKey("effect.minecraft.speed").registerAttributeModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "96dc968d-818f-4271-8dbf-6b799d603ad8", VampirismConfig.BALANCE.vsSpeedBoost.get(), AttributeModifier.Operation.MULTIPLY_TOTAL));
