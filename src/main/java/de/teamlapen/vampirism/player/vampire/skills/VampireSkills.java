...
public class VampireSkills {
    ...
    public static void registerVampireSkills(IForgeRegistry<ISkill> registry) {
        ...
        registry.register(actionSkillDesc("dark_blood_projectile", VampireActions.dark_blood_projectile));
        registry.register(actionSkillDesc("freeze", VampireActions.freeze));
        registry.register(actionSkillDesc("half_invulnerable", VampireActions.half_invulnerable));
        ...
        registry.register(actionSkillDesc("sunscreen", VampireActions.sunscreen));
        registry.register(actionSkillDesc("summon_bats", VampireActions.summon_bat));
        ...
        registry.register(actionSkillDesc("teleport", VampireActions.teleport));
        registry.register(actionSkillDesc("vampire_disguise", VampireActions.disguise_vampire));
        registry.register(actionSkill("vampire_invisibility", VampireActions.vampire_invisibility));
        ...
        registry.register(actionSkillDesc("vampire_rage", VampireActions.vampire_rage));
        registry.register(actionSkillDesc("vampire_regeneration", VampireActions.regen));
