...
public class HunterSkills {
    ...
    public static void registerHunterSkills(IForgeRegistry<ISkill> registry) {
        registry.register(new VampirismSkill.SimpleHunterSkill(SkillType.LEVEL.createIdForFaction(VReference.HUNTER_FACTION.getID()), false));
        registry.register(new VampirismSkill.SimpleHunterSkill(SkillType.LORD.createIdForFaction(VReference.HUNTER_FACTION.getID()), false));
