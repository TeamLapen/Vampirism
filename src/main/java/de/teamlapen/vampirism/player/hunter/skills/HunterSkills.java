...
public class HunterSkills {
    ...
    public static void registerHunterSkills(IForgeRegistry<ISkill> registry) {
        ...
        registry.register(new VampirismSkill.SimpleHunterSkill("hunter_attack_speed", false).registerAttributeModifier(Attributes.field_233825_h_/*ATTACK_SPEED*/, "8dd2f8cc-6ae1-4db1-9e14-96b4c74d7bf2", VampirismConfig.BALANCE.hsSmallAttackSpeedModifier.get(), AttributeModifier.Operation.MULTIPLY_TOTAL));
        registry.register(new VampirismSkill.SimpleHunterSkill("hunter_attack_speed_advanced", true).registerAttributeModifier(Attributes.field_233825_h_/*ATTACK_SPEED*/, "d9311f44-a4ba-4ef4-83f2-9274ae1a827e", VampirismConfig.BALANCE.hsMajorAttackSpeedModifier.get(), AttributeModifier.Operation.MULTIPLY_TOTAL));
        ...
        registry.register(new VampirismSkill.SimpleHunterSkill("stake1", false)
                .setDescription(() -> {
                    ...
                    if (VampirismConfig.BALANCE.hsInstantKill1FromBehind.get()) {
                        desc.func_230529_a_(new StringTextComponent(" "));
                        desc.func_230529_a_(new TranslationTextComponent("text.vampirism.from_behind"));
                    }
                    return desc;
                }));
