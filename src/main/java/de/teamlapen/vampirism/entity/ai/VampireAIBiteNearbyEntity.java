...
public class VampireAIBiteNearbyEntity extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (vampire.wantsBlood()) {
            ...
            if (list.size() > 1) {
                ...
                try {
                    list.sort((o1, o2) -> vampireEntity.getDistanceSqToEntity(o1) > vampireEntity.getDistanceSqToEntity(o2) ? 1 : -1);
                } catch (Exception e) {
    ...
    protected AxisAlignedBB getBiteBoundingBox() {
        return vampireEntity.getEntityBoundingBox().expand(0.5, 0.7, 0.5);
    }
}
