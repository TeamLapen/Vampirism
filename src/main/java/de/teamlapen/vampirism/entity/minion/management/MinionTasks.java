...
public class MinionTasks {
    ...
    public static final RegistryObject<CollectResourcesTask<VampireMinionEntity.VampireMinionData>> COLLECT_BLOOD = MINION_TASKS.register("collect_blood", () -> new CollectResourcesTask<VampireMinionEntity.VampireMinionData>(VReference.VAMPIRE_FACTION, data -> VampirismConfig.BALANCE.miResourceCooldown.get(), Arrays.asList(new WeightedRandomItem<>(BloodBottleItem.getStackWithDamage(BloodBottleItem.AMOUNT), 20), new WeightedRandomItem<>(new ItemStack(ModItems.HUMAN_HEART.get()), 5), new WeightedRandomItem<>(new ItemStack(Items.IRON_NUGGET, 12), 12), new WeightedRandomItem<>(new ItemStack(Items.GOLD_NUGGET, 6), 10))));
