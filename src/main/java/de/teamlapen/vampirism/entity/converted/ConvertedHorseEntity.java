...
public class ConvertedHorseEntity extends HorseEntity implements CurableConvertedCreature<HorseEntity, ConvertedHorseEntity> {
    ...
    public static boolean checkConvertedHorseSpawnRules(EntityType<? extends AnimalEntity> pGoat, IWorld pLevel, SpawnReason pSpawnType, BlockPos pPos, Random pRandom) {
        return pLevel.getDifficulty() != Difficulty.PEACEFUL && HorseEntity.checkAnimalSpawnRules(pGoat, pLevel, pSpawnType, pPos, pRandom);
    }
