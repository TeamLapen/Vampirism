...
public class InfectAction extends DefaultVampireAction {
    ...
    protected boolean activate(@NotNull IVampirePlayer vampire, @NotNull ActivationContext context) {
        ...
        if(creature != null ){
            ...
            player.level.playSound(null, vampire.getRepresentingPlayer().getX(), vampire.getRepresentingPlayer().getY() + 1.5d, vampire.getRepresentingPlayer().getZ(), SoundEvents.NOTE_BLOCK_BANJO, SoundSource.PLAYERS, 1, 1);
        }
