...
public class LordSkills {
    ...
    public static final DeferredHolder<ISkill<?>, ISkill<?>> LORD_SPEED = SKILLS.register("lord_speed", () -> new ActionSkill(LordActions.LORD_SPEED, ModSkillTreeTags.LORD, 1, true));
    public static final DeferredHolder<ISkill<?>, ISkill<?>> LORD_ATTACK_SPEED = SKILLS.register("lord_attack_speed", () -> new ActionSkill(LordActions.LORD_ATTACK_SPEED, ModSkillTreeTags.LORD, 1, true));
