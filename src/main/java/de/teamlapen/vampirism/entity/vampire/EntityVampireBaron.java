...
//        }
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(6, new EntityAIAvoidEntity(this, EntityPlayer.class, input -> input != null && !isLowerLevel(input), 6.0F, 0.6, 0.7F));//TODO Works only partially. Pathfinding somehow does not find escape routes //TODO needs EntityPlayer
