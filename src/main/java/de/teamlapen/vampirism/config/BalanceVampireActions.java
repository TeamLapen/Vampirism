...
public class BalanceVampireActions extends BalanceValues {
    ...
    @DefaultInt(value = 90, minValue = 0, name = "halfinvulnerable_cooldown")
    public int HALFINVULNERABLE_COOLDOWN;
    @DefaultInt(value = 15, minValue = 1, name = "halfinvulnerable_duration")
    public int HALFINVULNERABLE_DURATION;
    @DefaultDouble(value = 0.5D, minValue = 0.0D, comment = "damage threshold of max health for damage omitting")
