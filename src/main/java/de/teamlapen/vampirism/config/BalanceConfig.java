...
public class BalanceConfig {
    ...
    BalanceConfig(ForgeConfigSpec.Builder builder) {
        ...
        viHunterTrainerWeight = builder.comment("Weight of the Hunter Trainer Building inside the village").defineInRange("viHunterTrainerWeight", 50, 1, Integer.MAX_VALUE);
        viTotemWeight = builder.comment("Weight of the Totem Building inside the Village").defineInRange("viTotemWeight", 1,1,Integer.MAX_VALUE);
