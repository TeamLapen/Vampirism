...
public class BloodValuesFluidLoader extends BloodValueReader<ResourceLocation> {

    public BloodValuesFluidLoader(Consumer<Map<ResourceLocation, Float>> valueConsumer, String directory, String name) {
