...
public class ClientConfig {
    ...
    public final ModConfigSpec.BooleanValue enableHudActionCooldownRendering;
    public final ModConfigSpec.BooleanValue enableHudActionDurationRendering;
    ...
    ClientConfig(ModConfigSpec.@NotNull Builder builder) {
        ...
        builder.comment("Entity render").push("entity-rendering");
        ...
        builder.comment("World rendering").push("world-rendering");
        ...
        builder.comment("Gui rendering").push("gui-rendering");
        ...
        this.enableHudActionCooldownRendering = builder.comment("Disable the rendering of the action cooldowns in the HUD").define("enableHudActionCooldownRendering", true);
        this.enableHudActionDurationRendering = builder.comment("Disable the rendering of the action durations in the HUD").define("enableHudActionDurationRendering", true);
        ...
        // Internal - without builder push to hide in config screen
        builder.comment("Internal");
