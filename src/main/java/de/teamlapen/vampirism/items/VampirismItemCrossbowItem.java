 ...
 */
public abstract class VampirismItemCrossbowItem extends Item implements IFactionLevelItem<IHunterPlayer>, IVampirismCrossbow {
     ...
     */
    public VampirismItemCrossbowItem(int maxDamage, @NotNull Tiers material) {
    ...
    public static boolean hasAmmo(@NotNull Player player, @NotNull ItemStack crossbowStack) {
        ...
        if (i instanceof VampirismItemCrossbowItem) {
            return !((VampirismItemCrossbowItem) i).findAmmo(player, crossbowStack).isEmpty();
        }
        return false;
    }
