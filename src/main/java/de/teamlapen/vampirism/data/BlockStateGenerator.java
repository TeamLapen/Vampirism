...
public class BlockStateGenerator extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        //default blocks
        horizontalBlock(ModBlocks.GARLIC_BEACON_NORMAL.get(), models().withExistingParent("garlic_beacon_normal", modLoc("block/garlic_beacon")));
        horizontalBlock(ModBlocks.GARLIC_BEACON_WEAK.get(), models().withExistingParent("garlic_beacon_weak", modLoc("block/garlic_beacon")));
        horizontalBlock(ModBlocks.GARLIC_BEACON_IMPROVED.get(), models().withExistingParent("garlic_beacon_improved", modLoc("block/garlic_beacon")));
        horizontalBlock(ModBlocks.CHURCH_ALTAR.get(), models().getExistingFile(modLoc("block/church_altar")));
        ...
        getMultipartBuilder(ModBlocks.CURSED_GRASS.get())
                .part().modelFile(models().cubeBottomTop(ModBlocks.CURSED_GRASS.get().getRegistryName().toString(),modLoc("block/cursed_grass_side"), modLoc("block/cursed_earth"),modLoc("block/cursed_grass_top"))).addModel().end()
                .part().modelFile(models().cubeBottomTop(ModBlocks.CURSED_GRASS.get().getRegistryName().toString()+"_snowy",modLoc("block/cursed_grass_side_snowy"), modLoc("block/cursed_earth"),modLoc("block/cursed_grass_top"))).addModel().condition(BlockStateProperties.SNOWY, true).end();

        simpleBlock(ModBlocks.CURSED_ROOTS.get(), models().cross("cursed_roots", modLoc("block/cursed_roots")));
    ...
    private void createWoodStates() {
        ...
        models().withExistingParent(ModBlocks.DARK_SPRUCE_FENCE.get().getRegistryName().getPath() + "_inventory", new ResourceLocation("block/fence_inventory")).texture("texture", "block/" + ModBlocks.DARK_SPRUCE_PLANKS.get().getRegistryName().getPath());
        models().withExistingParent(ModBlocks.CURSED_SPRUCE_FENCE.get().getRegistryName().getPath() + "_inventory", new ResourceLocation("block/fence_inventory")).texture("texture", "block/" + ModBlocks.CURSED_SPRUCE_PLANKS.get().getRegistryName().getPath());
    ...
    private void createCursedBark() {
        ...
        ModelFile empty = models().getBuilder(ModBlocks.CURSED_BARK.get().getRegistryName().toString() + "_empty");
