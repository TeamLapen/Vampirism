...
public class ModBlockFamilies {
    ...
    public static final BlockFamily PURPLE_BRICKS = BlockFamilies.familyBuilder(ModBlocks.PURPLE_STONE_BRICKS.get()).wall(ModBlocks.PURPLE_STONE_BRICK_WALL.get()).stairs(ModBlocks.PURPLE_STONE_BRICK_STAIRS.get()).slab(ModBlocks.PURPLE_STONE_BRICK_SLAB.get()).getFamily();
    public static final BlockFamily PURPLE_STONE_TILES = BlockFamilies.familyBuilder(ModBlocks.PURPLE_STONE_TILES.get()).wall(ModBlocks.PURPLE_STONE_TILES_WALL.get()).stairs(ModBlocks.PURPLE_STONE_TILES_STAIRS.get()).slab(ModBlocks.PURPLE_STONE_TILES_SLAB.get()).getFamily();
