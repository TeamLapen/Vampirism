...
public class RecipesProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output) {
        ...
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_GARLIC.get(), 1).lava(1).requires(crossbow_arrow_normal, 1).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.GARLIC.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "garlic_arrow_1");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_GARLIC.get(), 2).lava(1).requires(crossbow_arrow_normal, 2).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.GARLIC.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "garlic_arrow_2");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_GARLIC.get(), 3).lava(1).requires(crossbow_arrow_normal, 3).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.GARLIC.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "garlic_arrow_3");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_BLEEDING.get(), 1).lava(1).requires(crossbow_arrow_normal, 1).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.BLEEDING.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "bleeding_arrow_1");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_BLEEDING.get(), 2).lava(1).requires(crossbow_arrow_normal, 2).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.BLEEDING.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "bleeding_arrow_2");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_BLEEDING.get(), 3).lava(1).requires(crossbow_arrow_normal, 3).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.BLEEDING.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "bleeding_arrow_3");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_VAMPIRE_KILLER.get(), 1).lava(1).requires(crossbow_arrow_normal, 1).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.VAMPIRE_KILLER.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "vampire_killer_arrow_1");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_VAMPIRE_KILLER.get(), 2).lava(1).requires(crossbow_arrow_normal, 2).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.VAMPIRE_KILLER.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "vampire_killer_arrow_2");
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(RecipeCategory.COMBAT, ModItems.CROSSBOW_ARROW_VAMPIRE_KILLER.get(), 3).lava(1).requires(crossbow_arrow_normal, 3).requires(NBTIngredient.of(true, OilUtils.createOilItem(ModOils.VAMPIRE_KILLER.get()))).unlockedBy("has_crossbow_arrow_normal", has(crossbow_arrow_normal)).save(output, "vampire_killer_arrow_3");
        ...
        AlchemyTableRecipeBuilder.builder(ModOils.VAMPIRE_KILLER).oilIngredient(ModOils.GARLIC.get()).input(Ingredient.of(ModTags.Items.HOLY_WATER)).save(output, new ResourceLocation(REFERENCE.MODID, "vampire_killer_oil"));
