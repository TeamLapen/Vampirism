...
public class RecipesProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull HolderLookup.Provider provider, @NotNull RecipeOutput output) {
        ...
        ItemLike blood_infused_enhanced_iron_block = ModBlocks.BLOOD_INFUSED_ENHANCED_IRON_BLOCK.get();
        ...
        ItemLike pure_salt = ModItems.PURE_SALT.get();
        ItemLike purified_garlic = ModItems.PURIFIED_GARLIC.get();
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_HEAD_NORMAL.get()).lava(1).pattern("LIIL").pattern("ISSI").pattern("L  L").define('L', leather).define('I', iron_ingot).define('S', potion(Potions.SWIFTNESS)).unlockedBy("has_leather", has(leather)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_CHEST_NORMAL.get()).lava(1).pattern("L  L").pattern("LIIL").pattern("ISSI").pattern("LIIL").define('L', leather).define('I', iron_ingot).define('S', potion(Potions.SWIFTNESS)).unlockedBy("has_leather", has(leather)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_LEGS_NORMAL.get()).pattern("LIIL").pattern("ISSI").pattern("I  I").pattern("L  L").define('L', leather).define('I', iron_ingot).define('S', potion(Potions.SWIFTNESS)).unlockedBy("has_leather", has(leather)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_FEET_NORMAL.get()).lava(1).pattern("L  L").pattern("S  S").pattern("I  I").pattern("L  L").define('L', leather).define('I', iron_ingot).define('S', potion(Potions.SWIFTNESS)).unlockedBy("has_leather", has(leather)).save(output);

        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_HEAD_ENHANCED.get()).lava(3).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("LIIL").pattern("GSSG").pattern("LGGL").define('L', leather).define('S', potion(Potions.STRONG_SWIFTNESS)).define('G', gold_ingot).define('I', iron_ingot).unlockedBy("has_leather", has(leather)).unlockedBy("has_gold", has(gold_ingot)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_CHEST_ENHANCED.get()).lava(3).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("L  L").pattern("GIIG").pattern("LSSL").pattern("GIIG").define('L', leather).define('S', potion(Potions.STRONG_SWIFTNESS)).define('G', gold_ingot).define('I', iron_ingot).unlockedBy("has_leather", has(leather)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_LEGS_ENHANCED.get()).lava(3).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("LIIL").pattern("GSSG").pattern("G  G").pattern("G  G").define('L', leather).define('S', potion(Potions.STRONG_SWIFTNESS)).define('G', gold_ingot).define('I', iron_ingot).unlockedBy("has_leather", has(leather)).unlockedBy("has_gold", has(gold_ingot)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_FEET_ENHANCED.get()).lava(3).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("I  I").pattern("S  S").pattern("G  G").pattern("L  L").define('L', leather).define('S', potion(Potions.STRONG_SWIFTNESS)).define('G', gold_ingot).define('I', iron_ingot).unlockedBy("has_leather", has(leather)).unlockedBy("has_garlic", has(garlic)).save(output);

        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_HEAD_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("LDDL").pattern("DPPD").pattern("L  L").define('L', leather).define('P', potion(ModPotions.VERY_STRONG_SWIFTNESS)).define('D', diamond).unlockedBy("has_leather", has(leather)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_CHEST_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("L  L").pattern("LDDL").pattern("DPPD").pattern("LDDL").define('L', leather).define('P', potion(ModPotions.VERY_STRONG_SWIFTNESS)).define('D', diamond).unlockedBy("has_leather", has(leather)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_LEGS_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("LDDL").pattern("DPPD").pattern("D  D").pattern("L  L").define('L', leather).define('P', potion(ModPotions.VERY_STRONG_SWIFTNESS)).define('D', diamond).unlockedBy("has_leather", has(leather)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.ARMOR_OF_SWIFTNESS_FEET_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("L  L").pattern("P  P").pattern("D  D").pattern("L  L").define('L', leather).define('P', potion(ModPotions.VERY_STRONG_SWIFTNESS)).define('D', diamond).unlockedBy("has_leather", has(leather)).save(output);

        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_HEAD_NORMAL.get()).lava(2).pattern("IIII").pattern("IGGI").define('I', iron_ingot).define('G', garlic).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_CHEST_NORMAL.get()).lava(2).pattern("I  I").pattern("IGGI").pattern("IIII").pattern(" II ").define('I', iron_ingot).define('G', garlic).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_LEGS_NORMAL.get()).lava(2).pattern("IIII").pattern("IGGI").pattern("I  I").define('I', iron_ingot).define('G', garlic).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_FEET_NORMAL.get()).lava(2).pattern("I  I").pattern("G  G").pattern("I  I").pattern("I  I").define('I', iron_ingot).define('G', garlic).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);

        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_HEAD_ENHANCED.get()).lava(4).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("IGGI").pattern("ISSI").define('I', iron_ingot).define('G', gold_ingot).define('S', pure_salt).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_CHEST_ENHANCED.get()).lava(4).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("I  I").pattern("ISSI").pattern("IGGI").pattern(" II ").define('I', iron_ingot).define('G', gold_ingot).define('S', pure_salt).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_LEGS_ENHANCED.get()).lava(4).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("IGGI").pattern("ISSI").pattern("I  I").pattern("I  I").define('I', iron_ingot).define('S', pure_salt).define('G', gold_ingot).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_FEET_ENHANCED.get()).lava(4).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("G  G").pattern("S  S").pattern("I  I").pattern("I  I").define('I', iron_ingot).define('G', gold_ingot).define('S', pure_salt).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_garlic", has(garlic)).save(output);

        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_HEAD_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("DDDD").pattern("DSSD").define('D', diamond).define('S', purified_garlic).unlockedBy("has_diamond", has(diamond)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_CHEST_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("D  D").pattern("DSSD").pattern("DDDD").pattern(" DD ").define('D', diamond).define('S', purified_garlic).unlockedBy("has_diamond", has(diamond)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_LEGS_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("DDDD").pattern("DSSD").pattern("D  D").pattern("D  D").define('D', diamond).define('S', purified_garlic).unlockedBy("has_diamond", has(diamond)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ModItems.HUNTER_COAT_FEET_ULTIMATE.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("D  D").pattern("S  S").pattern("D  D").pattern("D  D").define('D', diamond).define('S', purified_garlic).unlockedBy("has_diamond", has(diamond)).save(output);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ItemDataUtils.createEnchantment(ModItems.HUNTER_AXE_NORMAL.get(), enchantments.getOrThrow(Enchantments.KNOCKBACK), 2)).lava(5).pattern("GBII").pattern("GBI ").pattern("  S ").pattern("  S ").define('I', iron_ingot).define('G', garlic).define('B', iron_block).define('S', stick).unlockedBy("has_iron", has(iron_ingot)).save(output);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(RecipeCategory.COMBAT, ItemDataUtils.createEnchantment(ModItems.HUNTER_AXE_ENHANCED.get(), enchantments.getOrThrow(Enchantments.KNOCKBACK), 3)).lava(5).skills(HunterSkills.ENHANCED_WEAPONS.get()).pattern("GBDD").pattern("GBD ").pattern("  S ").pattern("  S ").define('G', purified_garlic).define('B', diamondBlock).define('D', diamond).define('S', stick).unlockedBy("has_diamond", has(diamond)).save(output);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.HEART_SEEKER_NORMAL.get()).pattern("IBI").pattern("IBI").pattern(" S ").define('B', blood_infused_iron_ingot).define('I', iron_ingot).define('S', stick).unlockedBy("has_ingot", has(blood_infused_iron_ingot)).save(output, vampire("heart_seeker_normal"));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.HEART_SEEKER_ENHANCED.get()).pattern("BEB").pattern("BEB").pattern(" S ").define('B', blood_infused_iron_ingot).define('E', blood_infused_enhanced_iron_ingot).define('S', stick).unlockedBy("has_ingot", has(blood_infused_enhanced_iron_ingot)).save(output, vampire("heart_seeker_enhanced"));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.HEART_SEEKER_ULTIMATE.get()).pattern("DED").pattern("DED").pattern(" S ").define('E', blood_infused_enhanced_iron_ingot).define('D', diamond).define('S', stick).unlockedBy("has_ingot", has(blood_infused_enhanced_iron_ingot)).save(output, vampire("heart_seeker_ultimate"));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.HEART_STRIKER_NORMAL.get()).pattern("BI").pattern("BI").pattern("S ").define('B', blood_infused_iron_ingot).define('I', iron_block).define('S', stick).unlockedBy("has_ingot", has(blood_infused_iron_ingot)).save(output, vampire("heart_striker_normal"));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.HEART_STRIKER_ENHANCED.get()).pattern("EI").pattern("EI").pattern("S ").define('E', blood_infused_enhanced_iron_ingot).define('I', blood_infused_enhanced_iron_block).define('S', stick).unlockedBy("has_ingot", has(blood_infused_enhanced_iron_ingot)).save(output, vampire("heart_striker_enhanced"));
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.HEART_STRIKER_ULTIMATE.get()).pattern("ED").pattern("ED").pattern("S ").define('E', blood_infused_enhanced_iron_ingot).define('D', diamondBlock).define('S', stick).unlockedBy("has_ingot", has(blood_infused_enhanced_iron_ingot)).save(output, vampire("heart_striker_ultimate"));
