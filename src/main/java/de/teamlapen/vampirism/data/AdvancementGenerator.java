    ...
    private static class HunterAdvancements implements Consumer<Consumer<Advancement>> {
        ...
        public void accept(Consumer<Advancement> consumer) {
            Advancement become_hunter = Advancement.Builder.advancement()
                    .display(ModItems.item_garlic, new TranslatableComponent("advancement.vampirism.become_hunter"), new TranslatableComponent("advancement.vampirism.become_hunter.desc"), null, FrameType.TASK, true, false, false)
                    .parent(root.get())
            ...
            Advancement stake = Advancement.Builder.advancement()
                    .display(ModItems.stake, new TranslatableComponent("advancement.vampirism.stake"), new TranslatableComponent("advancement.vampirism.stake.desc"), null, FrameType.CHALLENGE, true, true, true)
            ...
            Advancement betrayal = Advancement.Builder.advancement()
                    .display(ModItems.human_heart, new TranslatableComponent("advancement.vampirism.betrayal"), new TranslatableComponent("advancement.vampirism.betrayal.desc"), null, FrameType.TASK, true, true, true)
                    .parent(become_hunter)
            ...
            Advancement max_level = Advancement.Builder.advancement()
                    .display(ModItems.item_garlic, new TranslatableComponent("advancement.vampirism.max_level_hunter"), new TranslatableComponent("advancement.vampirism.max_level_hunter.desc"), null, FrameType.GOAL, true, true, true)
                    .parent(stake)
            ...
            Advancement technology = Advancement.Builder.advancement()
                    .display(ModItems.basic_tech_crossbow, new TranslatableComponent("advancement.vampirism.technology"), new TranslatableComponent("advancement.vampirism.technology.desc"), null, FrameType.TASK, true, true, true)
                    .parent(become_hunter)
            ...
            Advancement max_lord = Advancement.Builder.advancement()
                    .display(ModItems.hunter_minion_upgrade_special, new TranslatableComponent("advancement.vampirism.max_lord_hunter"), new TranslatableComponent("advancement.vampirism.max_lord_hunter"), null, FrameType.CHALLENGE, true, true, true)
                    .parent(max_level)
            ...
            Advancement cure_vampire = Advancement.Builder.advancement()
                    .display(ModItems.cure_apple, new TranslatableComponent("advancement.vampirism.cure_vampire_villager"), new TranslatableComponent("advancement.vampirism.cure_vampire_villager"), null, FrameType.TASK, true, true, true)
                    .parent(become_hunter)
    ...
    private static class MainAdvancements implements Consumer<Consumer<Advancement>> {
        ...
        public void accept(Consumer<Advancement> consumer) {
            root = Advancement.Builder.advancement()
                    .display(ModItems.vampire_fang, new TranslatableComponent("itemGroup.vampirism"), new TranslatableComponent("advancement.vampirism.desc"), new ResourceLocation(REFERENCE.MODID, "textures/block/castle_block_dark_brick.png"), FrameType.TASK, false, false, false)
                    .addCriterion("main", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.vampire_fang))
                    .addCriterion("second", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.item_garlic))
            ...
            Advancement vampire_forest = Advancement.Builder.advancement()
                    ...
                    .parent(root)
                    .addCriterion("main", LocationTrigger.TriggerInstance.located(LocationPredicate.inBiome(ModBiomes.VAMPIRE_FOREST_KEY)))
                    .addCriterion("second", LocationTrigger.TriggerInstance.located(LocationPredicate.inBiome(ModBiomes.VAMPIRE_FOREST_HILLS_KEY)))
                    .requirements(RequirementsStrategy.OR)
                    .save(consumer, REFERENCE.MODID + ":main/vampire_forest");
            Advancement ancient_knowledge = Advancement.Builder.advancement()
                    .display(ModItems.vampire_book, new TranslatableComponent("advancement.vampirism.ancient_knowledge"), new TranslatableComponent("advancement.vampirism.ancient_knowledge.desc"), null, FrameType.TASK, true, true, true)
                    .parent(vampire_forest)
                    .addCriterion("blood_container", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.vampire_book))
                    .save(consumer, REFERENCE.MODID + ":main/ancient_knowledge");
            Advancement regicide = Advancement.Builder.advancement()
                    .display(ModItems.pure_blood_0, new TranslatableComponent("advancement.vampirism.regicide"), new TranslatableComponent("advancement.vampirism.regicide.desc"), null, FrameType.CHALLENGE, true, true, true)
                    .parent(vampire_forest)
    ...
    private static class VampireAdvancements implements Consumer<Consumer<Advancement>> {
        ...
        public void accept(Consumer<Advancement> consumer) {
            Advancement become_vampire = Advancement.Builder.advancement()
                    .display(ModItems.vampire_fang, new TranslatableComponent("advancement.vampirism.become_vampire"), new TranslatableComponent("advancement.vampirism.become_vampire.desc"), null, FrameType.TASK, true, false, false)
                    .parent(root.get())
            ...
            Advancement first_blood = Advancement.Builder.advancement()
                    .display(ModItems.blood_bottle, new TranslatableComponent("advancement.vampirism.sucking_blood"), new TranslatableComponent("advancement.vampirism.sucking_blood.desc"), null, FrameType.TASK, true, true, true)
                    .parent(become_vampire)
            ...
            Advancement blood_cult = Advancement.Builder.advancement()
                    .display(ModBlocks.altar_infusion, new TranslatableComponent("advancement.vampirism.blood_cult"), new TranslatableComponent("advancement.vampirism.blood_cult.desc"), null, FrameType.TASK, true, true, true)
                    .parent(become_vampire)
            ...
            Advancement extra_storage = Advancement.Builder.advancement()
                    .display(ModBlocks.blood_container, new TranslatableComponent("advancement.vampirism.extra_storage"), new TranslatableComponent("advancement.vampirism.extra_storage.desc"), null, FrameType.TASK, true, true, true)
                    .parent(first_blood)
                    .addCriterion("blood_container", InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.blood_container))
                    .save(consumer, REFERENCE.MODID + ":vampire/extra_storage");
            Advancement max_level = Advancement.Builder.advancement()
                    .display(ModItems.vampire_fang, new TranslatableComponent("advancement.vampirism.max_level_vampire"), new TranslatableComponent("advancement.vampirism.max_level_vampire.desc"), null, FrameType.GOAL, true, true, true)
                    .parent(bat)
            ...
            Advancement sniped = Advancement.Builder.advancement()
                    .display(Items.ARROW, new TranslatableComponent("advancement.vampirism.sniped"), new TranslatableComponent("advancement.vampirism.sniped"), null, FrameType.TASK, true, true, true)
                    .parent(bat)
            ...
            Advancement yuck = Advancement.Builder.advancement()
                    .display(new DisplayInfo(ItemStack.of(potion), new TranslatableComponent("advancement.vampirism.yuck"), new TranslatableComponent("advancement.vampirism.yuck"), null, FrameType.TASK, true, true, true))
                    .parent(first_blood)
            ...
            Advancement max_lord = Advancement.Builder.advancement()
                    .display(ModItems.vampire_minion_upgrade_special, new TranslatableComponent("advancement.vampirism.max_lord_vampire"), new TranslatableComponent("advancement.vampirism.max_lord_vampire"), null, FrameType.CHALLENGE, true, true, true)
                    .parent(max_level)
    ...
    private static class MinionAdvancements implements Consumer<Consumer<Advancement>> {
        ...
        public void accept(Consumer<Advancement> consumer) {
            Advancement become_lord = Advancement.Builder.advancement()
                    .display(Items.PAPER, new TranslatableComponent("advancement.vampirism.become_lord"), new TranslatableComponent("advancement.vampirism.become_lord"), null, FrameType.TASK, true, true, true)
                    .parent(root.get())
            ...
            Advancement collect_blood = Advancement.Builder.advancement()
                    .display(ModItems.blood_bottle, new TranslatableComponent("advancement.vampirism.collect_blood"), new TranslatableComponent("advancement.vampirism.collect_blood.desc"), null, FrameType.TASK, true, true, true)
                    .parent(become_lord)
