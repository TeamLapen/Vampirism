...
public class TagGenerator {
    ...
    public static class ModEntityTypeTagsProvider extends EntityTypeTagsProvider {
        ...
        @Override
        protected void registerTags() {
            getOrCreateBuilder(ModTags.Entities.HUNTER).add(ModEntities.hunter, ModEntities.hunter_imob, ModEntities.advanced_hunter, ModEntities.advanced_hunter_imob, ModEntities.hunter_trainer);
            getOrCreateBuilder(ModTags.Entities.VAMPIRE).add(ModEntities.vampire, ModEntities.vampire_imob, ModEntities.advanced_vampire, ModEntities.advanced_vampire_imob, ModEntities.vampire_baron);
        }
    }
