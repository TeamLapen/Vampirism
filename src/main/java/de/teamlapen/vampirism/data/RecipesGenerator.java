...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> consumer) {
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_chest_normal).lava(5).pattern("ZXXZ").pattern("XYYX").pattern("XYYX").pattern("XYYX").define('X', iron_ingot).define('Y', obsidian).define('Z', leather).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_chest_enhanced).lava(5).skills(HunterSkills.enhanced_armor).pattern("ZXXZ").pattern("DYYD").pattern("XYYX").pattern("DYYD").define('X', iron_ingot).define('Y', obsidian).define('Z', leather).define('D', diamond).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_feet_normal).lava(5).pattern("    ").pattern("X  X").pattern("XYYX").pattern("XYYX").define('X', iron_ingot).define('Y', obsidian).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_feet_enhanced).lava(5).skills(HunterSkills.enhanced_armor).pattern("    ").pattern("XYYX").pattern("XYYX").pattern("XDDX").define('X', iron_ingot).define('Y', obsidian).define('D', diamond).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_head_enhanced).lava(5).skills(HunterSkills.enhanced_armor).pattern("XDDX").pattern("XYYX").pattern("XYYX").pattern("    ").define('X', iron_ingot).define('Y', obsidian).define('D', diamond).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_head_normal).lava(5).pattern("XXXX").pattern("XYYX").pattern("XYYX").pattern("    ").define('X', iron_ingot).define('Y', obsidian).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_legs_enhanced).lava(5).skills(HunterSkills.enhanced_armor).pattern("XDDX").pattern("XYYX").pattern("XYYX").pattern("XYYX").define('X', iron_ingot).define('Y', obsidian).define('D', diamond).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.obsidian_armor_legs_normal).lava(5).pattern("XXXX").pattern("XYYX").pattern("XYYX").pattern("XYYX").define('X', iron_ingot).define('Y', obsidian).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(ModItems.item_candelabra).pattern("YYY").pattern("ZAZ").define('Y', ItemTags.CANDLES).define('Z', iron_ingot).define('A', gold_ingot).unlockedBy("has_honey", has(ItemTags.CANDLES)).unlockedBy("has_iron", has(iron_ingot)).unlockedBy("has_gold", has(gold_ingot)).save(consumer, vampire("candelabra_candles"));
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.chandelier).pattern(" Y ").pattern("ZYZ").pattern("BAB").define('Y', ModItems.item_candelabra).define('Z', ItemTags.CANDLES).define('B', iron_ingot).define('A', gold_ingot).unlockedBy("has_honey", has(ItemTags.CANDLES)).unlockedBy("has_candelabra", has(ModItems.item_candelabra)).save(consumer, vampire("chandelier_candle"));
