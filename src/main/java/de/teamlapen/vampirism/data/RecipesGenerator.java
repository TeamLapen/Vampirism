...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.castle_slab_dark_brick, 6).patternLine("###").key('#', castle_block_dark_brick).addCriterion("has_castle_brick", this.hasItem(castle_block_dark_brick)).build(consumer, modId("general/castle_slab_dark_brick"));
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.castle_slab_dark_stone, 6).patternLine("###").key('#', castle_block_dark_stone).addCriterion("has_castle_brick", this.hasItem(castle_block_dark_stone)).build(consumer, modId("general/castle_slab_dark_stone"));
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.castle_slab_purple_brick, 6).patternLine("###").key('#', castle_block_purple_brick).addCriterion("has_castle_brick", this.hasItem(castle_block_purple_brick)).build(consumer, modId("general/castle_slab_purple_brick"));
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.castle_stairs_dark_brick, 4).patternLine("#  ").patternLine("## ").patternLine("###").key('#', castle_block_dark_brick).addCriterion("has_castle_brick", this.hasItem(castle_block_dark_brick)).build(consumer, modId("general/castle_stairs_dark_brick"));
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.castle_stairs_dark_stone, 4).patternLine("#  ").patternLine("## ").patternLine("###").key('#', castle_block_dark_stone).addCriterion("has_castle_brick", this.hasItem(castle_block_dark_stone)).build(consumer, general("castle_stairs_dark_stone"));
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.castle_stairs_purple_brick, 4).patternLine("#  ").patternLine("## ").patternLine("###").key('#', castle_block_purple_brick).addCriterion("has_castle_brick", this.hasItem(castle_block_purple_brick)).build(consumer, general("castle_stairs_purple_brick"));
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.church_altar).patternLine("XZX").patternLine("YYY").patternLine(" Y ").key('X', vampire_fang).key('Y', planks).key('Z', book).addCriterion("has_book", this.hasItem(book)).build(consumer, general("church_altar_new"));
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.armor_of_swiftness_chest_enhanced).lava(3).skills(HunterSkills.enhanced_armor).patternLine("XZZX").patternLine("XXXX").patternLine("XYYX").patternLine("XXXX").key('X', leather).key('Y', garlic).key('Z', gold_ingot).addCriterion("has_leather", this.hasItem(leather)).build(consumer);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.armor_of_swiftness_feet_enhanced).lava(3).skills(HunterSkills.enhanced_armor).patternLine("XZZX").patternLine("XYYX").patternLine("XXXX").key('X', leather).key('Y', garlic).key('Z', gold_ingot).addCriterion("has_leather", this.hasItem(leather)).build(consumer);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.armor_of_swiftness_head_enhanced).lava(3).skills(HunterSkills.enhanced_armor).patternLine("XXXX").patternLine("XYYX").patternLine("XZZX").key('X', leather).key('Y', garlic).key('Z', gold_ingot).addCriterion("has_leather", this.hasItem(leather)).build(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.armor_of_swiftness_legs_normal).patternLine("XXXX").patternLine("XYYX").patternLine("XZZX").patternLine("X  X").key('X', leather).key('Y', garlic).key('Z', potion(Potions.SWIFTNESS)).addCriterion("has_leather", this.hasItem(leather)).build(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.armor_of_swiftness_legs_enhanced).lava(3).skills(HunterSkills.enhanced_armor).patternLine("XXXX").patternLine("XYYX").patternLine("XZZX").patternLine("X  X").key('X', leather).key('Y', garlic).key('Z', gold_ingot).addCriterion("has_leather", this.hasItem(leather)).build(consumer);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.hunter_coat_chest_enhanced).lava(5).skills(HunterSkills.enhanced_armor).patternLine("XWWX").patternLine("XZZX").patternLine("XYYX").patternLine("XYYX").key('X', iron_ingot).key('Y', diamond).key('Z', garlic).key('W', vampire_fang).addCriterion("has_iron", this.hasItem(iron_ingot)).build(consumer);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.basic_crossbow).lava(1).patternLine("YXXY").patternLine(" ZZ ").patternLine(" ZZ ").key('X', iron_ingot).key('Y', string).key('Z', planks).addCriterion("has_iron", this.hasItem(iron_ingot)).build(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.basic_double_crossbow).lava(1).skills(HunterSkills.double_crossbow).patternLine("YXXY").patternLine("YXXY").patternLine(" ZZ ").patternLine(" ZZ ").key('X', iron_ingot).key('Y', string).key('Z', planks).addCriterion("has_iron", this.hasItem(iron_ingot)).build(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.basic_tech_crossbow).lava(5).skills(HunterSkills.tech_weapons).patternLine("YXXY").patternLine("XZZX").patternLine(" XX ").patternLine(" XX ").key('X', iron_ingot).key('Y', string).key('Z', diamond).addCriterion("has_iron", this.hasItem(iron_ingot)).build(consumer);
        ShapelessWeaponTableRecipeBuilder.shapelessWeaponTable(ModItems.crossbow_arrow_spitfire, 3).lava(1).addIngredient(crossbow_arrow_normal, 3).addIngredient(alchemical_fire).addCriterion("has_crossbow_arrow_normal", this.hasItem(crossbow_arrow_normal)).build(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.crossbow_arrow_vampire_killer, 3).lava(1).patternLine(" X ").patternLine("XYX").patternLine(" Z ").patternLine(" W ").key('X', garlic).key('Y', gold_ingot).key('Z', stick).key('W', feather).addCriterion("has_crossbow_arrow_normal", this.hasItem(crossbow_arrow_normal)).build(consumer);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.enhanced_tech_crossbow).lava(5).skills(HunterSkills.tech_weapons).patternLine("YXXY").patternLine("XZZX").patternLine("XZZX").patternLine(" XX ").key('X', iron_ingot).key('Y', string).key('Z', diamond).addCriterion("has_iron", this.hasItem(iron_ingot)).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_cloak_black_blue).patternLine("YZY").patternLine("XAX").patternLine("Y Y").key('X', blue_wool).key('Y', black_wool).key('Z', diamond).key('A', pure_blood).addCriterion("has_pure_blood", this.hasItem(pure_blood)).build(consumer, vampire("vampire_cloak_black_blue"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_cloak_black_red).patternLine("YZY").patternLine("XAX").patternLine("Y Y").key('X', red_wool).key('Y', black_wool).key('Z', diamond).key('A', pure_blood).addCriterion("has_pure_blood", this.hasItem(pure_blood)).build(consumer, vampire("vampire_cloak_black_red"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_cloak_black_white).patternLine("YZY").patternLine("XAX").patternLine("Y Y").key('X', white_wool).key('Y', black_wool).key('Z', diamond).key('A', pure_blood).addCriterion("has_pure_blood", this.hasItem(pure_blood)).build(consumer, vampire("vampire_cloak_black_white"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_cloak_white_black).patternLine("YZY").patternLine("XAX").patternLine("Y Y").key('X', black_wool).key('Y', white_wool).key('Z', diamond).key('A', pure_blood).addCriterion("has_pure_blood", this.hasItem(pure_blood)).build(consumer, vampire("vampire_cloak_white_black"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_cloak_red_black).patternLine("YZY").patternLine("XAX").patternLine("Y Y").key('X', black_wool).key('Y', red_wool).key('Z', diamond).key('A', pure_blood).addCriterion("has_pure_blood", this.hasItem(pure_blood)).build(consumer, vampire("vampire_cloak_red_black"));
