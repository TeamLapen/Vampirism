...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_white).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.WHITE_WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, vampire("coffin_white"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_orange).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.ORANGE_WOOL).unlockedBy("has_wool", has(Items.ORANGE_WOOL)).save(consumer, vampire("coffin_orange"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_magenta).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.MAGENTA_WOOL).unlockedBy("has_wool", has(Items.MAGENTA_WOOL)).save(consumer, vampire("coffin_magenta"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_light_blue).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.LIGHT_BLUE_WOOL).unlockedBy("has_wool", has(Items.LIGHT_BLUE_WOOL)).save(consumer, vampire("coffin_light_blue"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_yellow).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.YELLOW_WOOL).unlockedBy("has_wool", has(Items.YELLOW_WOOL)).save(consumer, vampire("coffin_yellow"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_lime).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.LIME_WOOL).unlockedBy("has_wool", has(Items.LIME_WOOL)).save(consumer, vampire("coffin_lime"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_pink).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.PINK_WOOL).unlockedBy("has_wool", has(Items.PINK_WOOL)).save(consumer, vampire("coffin_pink"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_gray).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.GRAY_WOOL).unlockedBy("has_wool", has(Items.GRAY_WOOL)).save(consumer, vampire("coffin_gray"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_light_gray).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.LIGHT_GRAY_WOOL).unlockedBy("has_wool", has(Items.LIGHT_GRAY_WOOL)).save(consumer, vampire("coffin_light_gray"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_cyan).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.CYAN_WOOL).unlockedBy("has_wool", has(Items.CYAN_WOOL)).save(consumer, vampire("coffin_cyan"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_purple).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.PURPLE_WOOL).unlockedBy("has_wool", has(Items.PURPLE_WOOL)).save(consumer, vampire("coffin_purple"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_blue).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.BLUE_WOOL).unlockedBy("has_wool", has(Items.BLUE_WOOL)).save(consumer, vampire("coffin_blue"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_brown).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.BROWN_WOOL).unlockedBy("has_wool", has(Items.BROWN_WOOL)).save(consumer, vampire("coffin_brown"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_green).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.GREEN_WOOL).unlockedBy("has_wool", has(Items.GREEN_WOOL)).save(consumer, vampire("coffin_green"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_red).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.RED_WOOL).unlockedBy("has_wool", has(Items.RED_WOOL)).save(consumer, vampire("coffin_red"));
        ShapedRecipeBuilder.shaped(ModBlocks.coffin_black).pattern("XXX").pattern("YYY").pattern("XXX").define('X', Items.SPRUCE_PLANKS).define('Y', Items.BLACK_WOOL).unlockedBy("has_wool", has(Items.BLACK_WOOL)).save(consumer, vampire("coffin_black"));
