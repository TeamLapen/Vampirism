...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.enhanced_crossbow).lava(2).skills(HunterSkills.enhanced_weapons).patternLine("YXXY").patternLine(" XX ").patternLine(" XX ").key('X', iron_ingot).key('Y', string).build(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.enhanced_double_crossbow).lava(3).skills(HunterSkills.double_crossbow, HunterSkills.enhanced_weapons).patternLine("YXXY").patternLine("YXXY").patternLine(" XX ").patternLine(" XX ").key('X', iron_ingot).key('Y', string).build(consumer);
        ...
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_clothing_legs).patternLine("XXX").patternLine("X X").patternLine("X X").key('X', Items.GRAY_WOOL).addCriterion("has_wool", hasItem(Items.GRAY_WOOL)).build(consumer, vampire("vampire_clothing_legs"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_clothing_boots).patternLine("X X").patternLine("X X").key('X', Items.BROWN_WOOL).addCriterion("has_wool", hasItem(Items.BROWN_WOOL)).build(consumer, vampire("vampire_clothing_boots"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_clothing_hat).patternLine(" XX").patternLine(" Y ").patternLine("XXX").key('X', Items.BLACK_WOOL).key('Y', Items.RED_WOOL).addCriterion("has_wool", hasItem(Items.BLACK_WOOL)).build(consumer, vampire("vampire_clothing_hat"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.vampire_clothing_crown).patternLine("X X").patternLine("XXX").key('X', Items.GOLD_INGOT).addCriterion("has_gold", hasItem(Items.GOLD_INGOT)).build(consumer, vampire("vampire_clothing_crown"));
    }
