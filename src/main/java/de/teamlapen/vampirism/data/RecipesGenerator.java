...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.blood_potion_table).patternLine("XXX").patternLine("Y Y").patternLine("ZZZ").key('X', glass_bottle).key('Y', planks).key('Z', iron_ingot).addCriterion("has_glass_bottle", hasItem(glass_bottle)).build(consumer, hunter("hunter_blood_potion_table"));
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.weapon_table).patternLine("X  ").patternLine("YYY").patternLine(" Z ").key('X', bucket).key('Y', iron_ingot).key('Z', iron_block).addCriterion("has_iron_ingot", hasItem(iron_ingot)).build(consumer, hunter("hunter_weapon_table"));
        ShapedRecipeBuilder.shapedRecipe(ModItems.crossbow_arrow_normal, 6).patternLine("X").patternLine("Y").key('X', iron_ingot).key('Y', stick).addCriterion("has_iron_ingot", hasItem(iron_ingot)).build(consumer, hunter("hunter_crossbow_arrow_normal"));
