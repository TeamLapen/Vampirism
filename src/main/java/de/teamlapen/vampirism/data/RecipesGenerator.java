...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(@Nonnull Consumer<FinishedRecipe> consumer) {
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.OBSIDIAN_ARMOR_CHEST_ENHANCED.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("ZXXZ").pattern("DYYD").pattern("XYYX").pattern("DYYD").define('X', iron_ingot).define('Y', obsidian).define('Z', leather).define('D', diamond).save(consumer);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.OBSIDIAN_ARMOR_FEET_ENHANCED.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("    ").pattern("XYYX").pattern("XYYX").pattern("XDDX").define('X', iron_ingot).define('Y', obsidian).define('D', diamond).save(consumer);
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.OBSIDIAN_ARMOR_HEAD_ENHANCED.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("XDDX").pattern("XYYX").pattern("XYYX").pattern("    ").define('X', iron_ingot).define('Y', obsidian).define('D', diamond).save(consumer);
        ...
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.OBSIDIAN_ARMOR_LEGS_ENHANCED.get()).lava(5).skills(HunterSkills.ENHANCED_ARMOR.get()).pattern("XDDX").pattern("XYYX").pattern("XYYX").pattern("XYYX").define('X', iron_ingot).define('Y', obsidian).define('D', diamond).save(consumer);
