...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModItems.crucifix_normal).pattern("XY ").pattern("ZYZ").pattern(" Y ").define('X', ModItems.holy_water_bottle_normal).define('Y', planks).define('Z', stick).unlockedBy("holy_water", has(ModItems.holy_water_bottle_normal)).unlockedBy("stick", has(stick)).unlockedBy("planks", has(planks)).save(consumer, hunter("crucifix"));
        ShapedWeaponTableRecipeBuilder.shapedWeaponTable(ModItems.crucifix_enhanced).pattern("XYYX").pattern("YZAY").pattern("XYYX").pattern("XYYX").define('X', ModItems.holy_water_bottle_normal).define('Y', iron_ingot).define('Z', ModItems.holy_water_bottle_enhanced).define('A', ModItems.stake).unlockedBy("iron", has(iron_ingot)).unlockedBy("has_holy_water", has(ModItems.holy_water_bottle_normal)).unlockedBy("holy_water_enhanced", has(ModItems.holy_water_bottle_enhanced)).unlockedBy("stake", has(ModItems.stake)).skills(HunterSkills.crucifix_wielder).save(consumer, hunter("crucifix_enhanced"));
