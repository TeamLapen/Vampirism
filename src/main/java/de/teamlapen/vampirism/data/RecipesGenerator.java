...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.totem_top_crafted).patternLine("X X").patternLine(" Y ").patternLine("XZX").key('X',obsidian).key('Y', diamond).key('Z',vampire_book).addCriterion("has_diamond", this.hasItem(diamondBlock)).addCriterion("has_obsidian", this.hasItem(obsidian)).build(consumer, general("totem_top"));
        ...
        ShapedRecipeBuilder.shapedRecipe(ModBlocks.potion_table).patternLine("XXX").patternLine("Y Y").patternLine("ZZZ").key('X', glass_bottle).key('Y', planks).key('Z', iron_ingot).addCriterion("has_glass_bottle", this.hasItem(glass_bottle)).build(consumer, hunter("hunter_potion_table"));
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.crossbow_arrow_normal).addIngredient(Items.ARROW).addCriterion("has_arrow",this.hasItem(Items.ARROW)).build(consumer, hunter("crossbow_arrow_from_vanilla"));
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.pure_blood_0).addIngredient(ModItems.pure_blood_1).addIngredient(ModItems.vampire_blood_bottle).addCriterion("pure_blood",this.hasItem(ModItems.pure_blood_1)).build(consumer,hunter("pure_blood0"));
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.pure_blood_1).addIngredient(ModItems.pure_blood_2).addIngredient(ModItems.vampire_blood_bottle).addCriterion("pure_blood",this.hasItem(ModItems.pure_blood_2)).build(consumer,hunter("pure_blood1"));
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.pure_blood_2).addIngredient(ModItems.pure_blood_3).addIngredient(ModItems.vampire_blood_bottle).addCriterion("pure_blood",this.hasItem(ModItems.pure_blood_3)).build(consumer,hunter("pure_blood2"));
        ShapelessRecipeBuilder.shapelessRecipe(ModItems.pure_blood_3).addIngredient(ModItems.pure_blood_4).addIngredient(ModItems.vampire_blood_bottle).addCriterion("pure_blood",this.hasItem(ModItems.pure_blood_4)).build(consumer,hunter("pure_blood3"));
