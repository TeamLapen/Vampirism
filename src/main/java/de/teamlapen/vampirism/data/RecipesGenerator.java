...
public class RecipesGenerator extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModItems.vampire_clothing_legs).pattern("XXX").pattern("X X").pattern("XYX").define('X', Items.GRAY_WOOL).define('Y', Ingredient.of(heart)).unlockedBy("has_heart", has(heart)).unlockedBy("has_wool", has(Items.GRAY_WOOL)).save(consumer, vampire("vampire_clothing_legs"));
        ShapedRecipeBuilder.shaped(ModItems.vampire_clothing_boots).pattern("XYX").pattern("X X").define('X', Items.BROWN_WOOL).define('Y', Ingredient.of(heart)).unlockedBy("has_heart", has(heart)).unlockedBy("has_wool", has(Items.BROWN_WOOL)).save(consumer, vampire("vampire_clothing_boots"));
        ShapedRecipeBuilder.shaped(ModItems.vampire_clothing_hat).pattern("ZXX").pattern(" Y ").pattern("XXX").define('X', Items.BLACK_WOOL).define('Y', Items.RED_WOOL).define('Z', Ingredient.of(heart)).unlockedBy("has_heart", has(heart)).unlockedBy("has_wool", has(Items.BLACK_WOOL)).save(consumer, vampire("vampire_clothing_hat"));
        ShapedRecipeBuilder.shaped(ModItems.vampire_clothing_crown).pattern("XYX").pattern("XXX").define('X', Items.GOLD_INGOT).define('Y', Ingredient.of(heart)).unlockedBy("has_heart", has(heart)).unlockedBy("has_gold", has(Items.GOLD_INGOT)).save(consumer, vampire("vampire_clothing_crown"));
        ...
        woodenSign(consumer, ModItems.dark_spruce_sign, ModBlocks.DARK_SPRUCE_PLANKS.get());
        woodenSign(consumer, ModItems.cursed_spruce_sign, ModBlocks.CURSED_SPRUCE_PLANKS.get());
        woodenBoat(consumer, ModItems.dark_spruce_boat, ModBlocks.DARK_SPRUCE_PLANKS.get());
        woodenBoat(consumer, ModItems.cursed_spruce_boat, ModBlocks.CURSED_SPRUCE_PLANKS.get());
