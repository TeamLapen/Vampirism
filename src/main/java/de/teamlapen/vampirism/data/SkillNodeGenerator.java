...
public class SkillNodeGenerator implements DataProvider {
    ...
    protected void registerSkillNodes(Consumer<FinishedSkillNode> consumer) {
        //hunter
        {
            ...
            ResourceLocation alchemy4 = SkillNodeBuilder.hunter(alchemy2, HunterSkills.PURIFIED_GARLIC.get(), HunterSkills.HOLY_WATER_ENHANCED.get()).build(consumer, modId("alchemy4"));
