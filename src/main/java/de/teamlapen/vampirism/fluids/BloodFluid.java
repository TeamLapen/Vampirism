...
public class BloodFluid extends VampirismFluid {
    ...
    protected FluidAttributes createAttributes(Fluid p_createAttributes_1_) {
        return FluidAttributes.builder("blood", new ResourceLocation(REFERENCE.MODID, "blocks/blood_still"), new ResourceLocation(REFERENCE.MODID, "blocks/blood_flow")).color(0xEEFF1111).density(1300).temperature(309).viscosity(3000).rarity(Rarity.UNCOMMON).build();
    }
