...
public class TileSunscreenBeacon extends TileEntity implements ITickable {
    ...
    private void updateBeacon() {
        ...
        if (this.world != null && !this.world.isRemote) {
            ...
            int z = this.pos.getZ();
            int distance = 32;
            AxisAlignedBB axisalignedbb = (new AxisAlignedBB((double) x, 0, (double) z, (double) (x + 1), (double) (y + 1), (double) (z + 1))).expandXyz(distance).addCoord(0.0D, (double) this.world.getHeight(), 0.0D);
