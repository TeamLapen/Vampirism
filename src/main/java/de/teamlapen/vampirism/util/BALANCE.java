...
public final class BALANCE {
	...
	/**
	 * Class to store all constants related to the player modifiers See {@link: de.teamlapen.vampirism.entity.player.PlayerModifiers#applyModifiers(int, net.minecraft.entity.player.EntityPlayer)} for
	 * impact
	 *
	 */
	...
	/**
	 * Duration, cooldown etc for vampire player skills. Time values should be in seconds
	 */
