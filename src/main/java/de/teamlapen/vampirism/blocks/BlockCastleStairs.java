...
public class BlockCastleStairs extends StairsBlock {
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader player, List<ITextComponent> tooltip, ITooltipFlag advanced) {
        ...
        tooltip.add(new TranslationTextComponent(getTranslationKey() + (variant == BlockCastleBlock.EnumVariant.DARK_STONE ? ".no_spawn" : ".vampire_spawn")).applyTextStyle(TextFormatting.ITALIC));
