 ...
 */
@Mod(modid = LIBREFERENCE.MODID, name = LIBREFERENCE.NAME, version = LIBREFERENCE.VERSION, acceptedMinecraftVersions = "[1.9]", dependencies = "required-after:Forge@[" + LIBREFERENCE.FORGE_VERSION_MIN + ",)")
