...
public abstract class DefaultSkill<T extends IFactionPlayer> extends ForgeRegistryEntry<ISkill> implements ISkill {
    ...
    private final Map<IAttribute, LazyOptional<AttributeModifier>> attributeModifierMap = new HashMap<>();
    @Nullable
    ...
    public DefaultSkill<T> registerAttributeModifier(IAttribute attribute, String uuid, Supplier<Double> amountSupplier, AttributeModifier.Operation operation) {
