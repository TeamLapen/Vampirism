...
public class ExtendedPotionMix {
    ...
    public static class Builder {
        ...
        private @NotNull LazyOptional<Ingredient> reagent1 = LazyOptional.of(EMPTY_SUPPLIER);
        private int reagent1Count = 0;
        private int reagent1CountReduced = -1;
        private @NotNull LazyOptional<Ingredient> reagent2 = LazyOptional.of(EMPTY_SUPPLIER);
