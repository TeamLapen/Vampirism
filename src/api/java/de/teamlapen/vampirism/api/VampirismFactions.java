...
public class VampirismFactions {
    ...
    public static final DeferredFaction<INeutralPlayer, IPlayableFaction<INeutralPlayer>> NEUTRAL = factionHolder(Keys.NEUTRAL);
    ...
    public static class Keys {
        ...
        public static final ResourceLocation NEUTRAL = VResourceLocation.mod("neutral");
    }
}
