...
import { SkillBranch, UnlockAction} from "../../_components/Skills";
...
<Skill title="Equipment Collect" icon="hunter_minion_collect.png">

Enables the Equipment Collect task for minions.
</Skill>

<Skill title="Better Minions" icon="hunter_minion_stats_increase.png">

Increase basic stats of hunter minions
</Skill>

<Skill title="Technology" icon="minion_tech_crossbows.png">

Allows hunter minions to use semi-automatic crossbows
</Skill>