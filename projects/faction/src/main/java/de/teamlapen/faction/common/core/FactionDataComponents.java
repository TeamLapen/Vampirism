...
public class FactionDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Integer>> OBLIVION_PORTIONS = ITEM_DATA_COMPONENTS.registerComponentType(de.teamlapen.faction.api.FactionDataComponents.Keys.OBLIVION_PORTIONS.getPath(), builder -> builder.persistent(Codec.INT).networkSynchronized(ByteBufCodecs.VAR_INT));
