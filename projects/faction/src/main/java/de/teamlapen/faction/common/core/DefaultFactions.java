...
public class DefaultFactions {
    ...
    public static final DeferredFaction<INeutralPlayer, IPlayableFaction<INeutralPlayer>> NEUTRAL = FACTIONS.registerFaction(Factions.Keys.NEUTRAL.getPath(), prop -> new PlayableFaction<>(prop.playerAttachment(FactionAttachments.NEUTRAL_PLAYER).color(ARGB.white(1))));
