...
public class FactionBlocks {
    ...
    public static final DeferredBlock<TotemTopBlock> TOTEM_TOP = BLOCKS.registerBlock("totem_top", props -> new TotemTopBlock(props, false, null), () -> TotemTopBlock.properties(of()));
    public static final DeferredBlock<TotemTopBlock> TOTEM_TOP_CRAFTED = BLOCKS.registerBlock("totem_top_crafted", props -> new TotemTopBlock(props, true, null), props(TOTEM_TOP));
