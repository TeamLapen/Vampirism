...
public class MinionArgument implements ArgumentType<MinionArgument.MinionId> {
    ...
    public static final SimpleCommandExceptionType NO_MINION_FOUND = new SimpleCommandExceptionType(Component.translatable("command.factionapi.argument.minion.notfound"));
