...
public interface ITaskManager {
     ...
     */
    void abortTask(UUID taskBoardId, UUID taskInstance, boolean remove);
     ...
     * @implNote does not sync changes to the client
     */
    void acceptTask(UUID taskBoardId, UUID taskInstance);
     ...
     */
    void completeTask(UUID taskBoardId, UUID taskInstance);
     ...
     */
    boolean wasTaskCompleted(ResourceKey<Task> task);
}
