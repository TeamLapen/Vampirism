...
public class ActionHandler<T extends IFactionPlayer<T> & ISkillPlayer<T>> extends PropertySync implements IActionHandler<T>, ValueIOSerializable {
    ...
    protected void registerProperties() {
        this.registerProperty(FResourceLocation.mod("cooldown_timer")).simple(SafeCast.<Codec<Map<Holder<? extends IAction<T>>, Integer>>>cast(ACTION_TIME_CODEC))
                ...
                .register();
        this.registerProperty(FResourceLocation.mod("duration_timer")).simple(SafeCast.<Codec<Map<Holder<? extends ILastingAction<T>>, Integer>>>cast(LASTING_ACTION_TIME_CODEC))
                .defaultValue(HashMap::new)
                ...
                .register();
        this.registerProperty(FResourceLocation.mod("expected_cooldown_timer")).simple(SafeCast.<Codec<Map<Holder<? extends IAction<T>>, Integer>>>cast(ACTION_TIME_CODEC))
                .defaultValue(HashMap::new)
                ...
                .register();
        this.registerProperty(FResourceLocation.mod("expected_duration_timer")).simple(SafeCast.<Codec<Map<Holder<? extends IAction<T>>, Integer>>>cast(ACTION_TIME_CODEC))
                .defaultValue(HashMap::new)
                ...
                .register();
        this.registerProperty(FResourceLocation.mod("unlocked_actions")).list(SafeCast.<Codec<Holder<? extends IAction<T>>>>cast(IAction.CODEC))
