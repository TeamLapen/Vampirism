package de.teamlapen.factions.client.gui;
...
public class GuiRenderer {
    ...
    public static void blit(GuiGraphics graphics, Identifier texture, int x, int y, int width, int height, int imageWidth, int imageHeight) {
        graphics.blit(RenderPipelines.GUI_TEXTURED, texture, x, y, 0, 0, width, height, imageWidth, imageHeight);
    }

    public static void blitColored(GuiGraphics graphics, Identifier texture, int x, int y, int width, int height, int imageWidth, int imageHeight, int color) {
        graphics.blit(RenderPipelines.GUI_TEXTURED, texture, x, y, 0, 0, width, height, imageWidth, imageHeight, color);
    }

    public static void blitWithOffset(GuiGraphics graphics, Identifier texture, int x, int y, int xOffset, int yOffset, int width, int height) {
    ...
    public static void blitWithOffset(GuiGraphics graphics, Identifier texture, int x, int y, int xOffset, int yOffset, int width, int height, int imageWidth, int imageHeight) {
        graphics.blit(RenderPipelines.GUI_TEXTURED, texture, x, y, xOffset, yOffset, width, height, imageWidth, imageHeight);
    }

    public static void blitSpriteTiled(GuiGraphics graphics, Identifier texture, int x, int y, int width, int height, int color) {
        graphics.blitSprite(RenderPipelines.GUI_TEXTURED, texture, x, y, width, height, color);
    }

    public static void blitSprite(GuiGraphics graphics, Identifier texture, int textureWidth, int textureHeight, int uPosition, int vPosition, int x, int y, int uWidth, int vHeight, int color) {
