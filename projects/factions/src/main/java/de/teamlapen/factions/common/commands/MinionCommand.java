package de.teamlapen.factions.common.commands;
...
public class MinionCommand extends BasicCommand {
    ...
    public static ArgumentBuilder<CommandSourceStack, ?> registerNew() {
        ...
        @Unmodifiable Map<Holder<? extends IPlayableFaction<?>>, List<Pair<ResourceKey<IMinionEntry<?, ?>>, IMinionEntry<?, ?>>>> minionEntries = FactionsMod.services().factionRegistry().getFactionMinionEntries();
