...
/**
 * logger for vampirism faction stuff that is only initialized for dedicated server and only woorking if {@link de.teamlapen.factions.common.config.CommonConfig#enableFactionLogging} is true<br>
