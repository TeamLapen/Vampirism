...
public class MinionWorldData extends SavedData implements ValueIOSerializable {
    public static final SavedDataType<MinionWorldData> TYPE = new SavedDataType<>(FResourceLocation.modString("minion_data").replace(':', '_'), MinionWorldData::new, MinionWorldData::makeCodec);
