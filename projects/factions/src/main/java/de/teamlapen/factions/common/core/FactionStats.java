...
public class FactionStats {
    ...
    private static final DeferredRegister<ResourceLocation> CUSTOM_STAT = DeferredRegister.create(Registries.CUSTOM_STAT, REFERENCE.MOD_ID);
    ...
    private static DeferredHolder<ResourceLocation, ResourceLocation> add(String name, StatFormatter formatter) {
        var id = FResourceLocation.loc(CUSTOM_STAT.getNamespace(), name);
