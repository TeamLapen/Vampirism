...
public class VampirismJEIPlugin implements IModPlugin {
    ...
    public void registerGuiHandlers(@NotNull IGuiHandlerRegistration registration) {
        ...
        registration.addRecipeClickArea(VaporStillScreen.class, 145, 17, 9, 28, POTION);
    ...
    public void registerRecipes(@NotNull IRecipeRegistration registration) {
        ...
        registration.addRecipes(POTION, VampirismApi.services().extendedBrewingRecipeRegistry().getPotionMixes().stream().map(JEIPotionMix::createFromMix).flatMap(Collection::stream).collect(Collectors.toList()));
