...
public class ModStats {
    ...
    public static final DeferredHolder<Identifier, Identifier> WEAPON_TABLE = add("weapon_table");
    public static final DeferredHolder<Identifier, Identifier> INTERACT_ALCHEMICAL_CAULDRON = add("interact_alchemical_cauldron");
    ...
    public static final DeferredHolder<Identifier, Identifier> ALTAR_OF_INSPIRATION_RITUALS_PERFORMED = add("altar_of_inspiration_rituals_performed");
    public static final DeferredHolder<Identifier, Identifier> ALTAR_OF_INFUSION_RITUALS_PERFORMED = add("altar_of_infusion_rituals_performed");
