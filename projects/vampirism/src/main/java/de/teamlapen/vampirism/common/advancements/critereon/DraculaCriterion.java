...
public class DraculaCriterion implements EntitySubPredicate {

    public static final DraculaCriterion INSTANCE = new DraculaCriterion();
    public static final MapCodec<DraculaCriterion> CODEC = MapCodec.unit(INSTANCE);
