...
public abstract class BloodFluid {
    ...
    public static final BaseFlowingFluid.Properties PROPERTIES = new BaseFlowingFluid.Properties(ModFluids.BLOOD_TYPE, ModFluids.BLOOD, ModFluids.FLOWING_BLOOD).bucket(ModItems.BLOOD_BUCKET).block(ModBlocks.BLOOD).explosionResistance(100.0F).tickRate(9);
