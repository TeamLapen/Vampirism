...
public class VampireHurtByTargetGoal extends HurtByTargetGoal {
    ...
    protected void alertOthers() {
        ...
        for (Mob possibleDefender : list) {
            ...
            if (possibleDefender != mob && possibleDefender.typeHolder().is(ModEntityTags.ALERTABLE_VAMPIRES) && attacker != null && !Helper.isVampire(attacker) && possibleDefender.getTarget() == null && !possibleDefender.isAlliedTo(attacker)) {
