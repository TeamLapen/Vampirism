...
public class DefaultConvertingHandler<T extends PathfinderMob> implements IConvertingHandler<T> {
    ...
    public IConvertedCreature<T> createFrom(@NotNull T entity) {
        ...
        return SpawnUtil.createEntity((EntityType<ConvertedCreatureEntity<T>>) (Object) ModEntities.CONVERTED_CREATURE.get(), entity.level(), EntitySpawnReason.CONVERSION).map(convertedCreature -> {
