...
public class ModBlocks {
    ...
    public static final DeferredBlock<VaporStillBlock> VAPOR_STILL = registerWithItem("vapor_still", VaporStillBlock::new, () -> basicProperties().mapColor(MapColor.COLOR_ORANGE).strength(3.0F, 6.0F).sound(SoundType.COPPER).noOcclusion());
