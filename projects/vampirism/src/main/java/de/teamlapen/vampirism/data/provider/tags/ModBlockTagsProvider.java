...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider holderLookup) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(ModBlocks.GARLIC_DIFFUSER_LONG.get())
                .add(ModBlocks.GARLIC_DIFFUSER_NORMAL.get())
                .add(ModBlocks.GARLIC_DIFFUSER_STRONG.get())
        ...
        tag(BlockTags.WOODEN_DOORS).add(ModBlocks.DARK_SPRUCE_DOOR.get(), ModBlocks.CURSED_SPRUCE_DOOR.get());
        tag(BlockTags.WOODEN_TRAPDOORS).add(ModBlocks.DARK_SPRUCE_TRAPDOOR.get(), ModBlocks.CURSED_SPRUCE_TRAPDOOR.get());
        tag(FactionBlockTags.TOTEM_TOP_FRAGILE).add(ModBlocks.TOTEM_TOP_VAMPIRISM_HUNTER.get(), ModBlocks.TOTEM_TOP_VAMPIRISM_VAMPIRE.get());
        tag(FactionBlockTags.TOTEM_TOP_CRAFTED).add(ModBlocks.TOTEM_TOP_VAMPIRISM_HUNTER_CRAFTED.get(), ModBlocks.TOTEM_TOP_VAMPIRISM_VAMPIRE_CRAFTED.get());
        ...
        tag(ModBlockTags.VAMPIRE_BEACON_BASE_BLOCKS).add(ModBlocks.BLOOD_INFUSED_IRON_BLOCK.get(), ModBlocks.BLOOD_INFUSED_ENHANCED_IRON_BLOCK.get(), ModBlocks.BLOOD_INFUSED_REFINED_IRON_BLOCK.get());
        tag(ModBlockTags.VAMPIRE_BEACON_BASE_ENHANCED_BLOCKS).add(ModBlocks.BLOOD_INFUSED_ENHANCED_IRON_BLOCK.get(), ModBlocks.BLOOD_INFUSED_REFINED_IRON_BLOCK.get());
        tag(ModBlockTags.VAMPIRE_BEACON_BASE_REFINED_BLOCKS).add(ModBlocks.BLOOD_INFUSED_REFINED_IRON_BLOCK.get());
        tag(ModBlockTags.CREEPER_REPELLENT).add(ModBlocks.VAMPIRE_SOUL_LANTERN.get());
        tag(ModBlockTags.GARLIC_FINDER_HIGHLIGHTED).add(ModBlocks.GARLIC_DIFFUSER_NORMAL.get(), ModBlocks.GARLIC_DIFFUSER_LONG.get(), ModBlocks.GARLIC_DIFFUSER_STRONG.get(), ModBlocks.GARLIC_DIFFUSER_CORE.get(), ModBlocks.GARLIC_DIFFUSER_CORE_STRONG.get());
