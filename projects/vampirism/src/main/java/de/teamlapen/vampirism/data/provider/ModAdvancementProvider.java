    ...
    private static class VampirismAdvancements implements AdvancementSubProvider {
        ...
        public void generate(HolderLookup.@NotNull Provider registries, Consumer<AdvancementHolder> consumer) {
            ...
            AdvancementHolder root = Advancement.Builder.advancement()
                    .display(ModItems.VAMPIRE_FANG.get(), Component.translatable("advancement.vampirism"), Component.translatable("advancement.vampirism.desc"), VResourceLocation.mod("block/dark_stone_bricks"), AdvancementType.TASK, false, false, false)
