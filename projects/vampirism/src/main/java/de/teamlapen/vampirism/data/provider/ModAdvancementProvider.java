    ...
    private static class HunterAdvancements implements VampirismAdvancementSubProvider {
        ...
        public void generate(AdvancementHolder root, HolderLookup.Provider holderProvider, Consumer<AdvancementHolder> consumer) {
            ...
            AdvancementHolder hunter_crossbow = Advancement.Builder.advancement()
                    ...
                    .parent(become_hunter)
                    .addCriterion("crossbow", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, ModItemTags.BASIC_CROSSBOWS).build()))
                    .addCriterion("faction", FactionCriterionTrigger.TriggerInstance.level(ModFactions.HUNTER, 1))
            ...
            AdvancementHolder enhanced_crossbow = Advancement.Builder.advancement()
                    ...
                    .addCriterion("crossbow", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, ModItemTags.ENHANCED_CROSSBOWS).build()))
                    .addCriterion("faction", FactionCriterionTrigger.TriggerInstance.level(ModFactions.HUNTER, 1))
                    .requirements(AdvancementRequirements.Strategy.AND)
            ...
            AdvancementHolder tech_crossbow = Advancement.Builder.advancement()
                    ...
                    .addCriterion("crossbow", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, ModItemTags.TECH_CROSSBOWS).build()))
                    .addCriterion("faction", FactionCriterionTrigger.TriggerInstance.level(ModFactions.HUNTER, 1))
                    .requirements(AdvancementRequirements.Strategy.AND)
            ...
            AdvancementHolder brochette = Advancement.Builder.advancement()
                    ...
                    .parent(hunter_crossbow)
                    .addCriterion("killed", CriteriaTriggers.KILLED_BY_ARROW.createCriterion(new KilledByArrowTrigger.TriggerInstance(Optional.empty(), List.of(), MinMaxBounds.Ints.exactly(7), Optional.of(ItemPredicate.Builder.item().of(items, ModItemTags.CROSSBOWS).build()))))
                    .addCriterion("faction", FactionCriterionTrigger.TriggerInstance.level(ModFactions.HUNTER, 1))
                    .requirements(AdvancementRequirements.Strategy.AND)
