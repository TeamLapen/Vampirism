package de.teamlapen.vampirism.common.entity.player.vampire.properties;

import de.teamlapen.sync.Property;
import de.teamlapen.sync.PropertySync;
import de.teamlapen.sync.SubPropertySync;
...
public class VisionStatus extends SubPropertySync implements ValueIOSerializable {
    ...
    protected void registerProperties() {
        this.registerProperty(VResourceLocation.mod("vision")).nullable(IVampireVision.CODEC).provider(() -> this.vision).commonLoader(v -> {
            var old = this.vision;
            this.vision = v;
            if (old != this.vision) {
                if (old != null) {
