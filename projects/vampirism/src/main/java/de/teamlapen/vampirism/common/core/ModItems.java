...
public class ModItems {
    ...
    public static final DeferredItem<SerumInjectionItem> SERUM_INJECTION = ITEMS.registerItem("serum_injection", SerumInjectionItem::new, props -> FactionRestriction.builder(VampirismTags.Factions.IS_HUNTER).message(SerumInjectionItem.MASSAGE_RESTRICTION_SYRINGE).apply(props.component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.6F).stacksTo(2).useCooldown(8)));
