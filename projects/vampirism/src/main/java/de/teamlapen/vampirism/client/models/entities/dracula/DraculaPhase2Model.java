...
public class DraculaPhase2Model extends DraculaModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cloak_center = cloak.addOrReplaceChild("cloak_center", CubeListBuilder.create().texOffs(128, 0).addBox(-8.0F, -1.0F, -1.0F, 16.0F, 62.0F, 0.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1047F, 0.0F, 0.0F));
        PartDefinition cloak_right = cloak.addOrReplaceChild("cloak_right", CubeListBuilder.create().texOffs(192, 50).addBox(-10.0F, 1.0F, -0.9F, 16.0F, 60.0F, 0.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1047F, 0.0349F, 0.2269F));
        PartDefinition cloak_left = cloak.addOrReplaceChild("cloak_left", CubeListBuilder.create().texOffs(160, 50).addBox(-6.0F, 1.0F, -0.9F, 16.0F, 60.0F, 0.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1047F, -0.0349F, -0.2269F));
