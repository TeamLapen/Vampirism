...
public class StandingCandelabraBlock extends CandleHolderBlock {
    ...
    private static final Pair<VoxelShape, VoxelShape> SHAPES = ShapeUtil.getShapesRotatedSymmetrically(Stream.of(Block.box(6, 0, 6, 10, 1, 10), Block.box(2, 0, 7, 14, 8, 9), Block.box(1, 6, 6, 5, 8, 10), Block.box(11, 6, 6, 15, 8, 10), Block.box(6, 8, 6, 10, 10, 10)).reduce((v1, v2) -> Shapes.join(v1, v2, BooleanOp.OR)).get());
    private static final Pair<VoxelShape, VoxelShape> SHAPE_WITH_CANDLES = ShapeUtil.getShapesRotatedSymmetrically(Stream.of(Block.box(6, 0, 6, 10, 1, 10), Block.box(2, 0, 7, 14, 8, 9), Block.box(1, 6, 6, 5, 8, 10), Block.box(2, 8, 7, 4, 13, 9), Block.box(7, 10, 7, 9, 15, 9), Block.box(12, 8, 7, 14, 13, 9), Block.box(11, 6, 6, 15, 8, 10), Block.box(6, 8, 6, 10, 10, 10)).reduce((v1, v2) -> Shapes.join(v1, v2, BooleanOp.OR)).get());
