...
public class ModSuggestionProvider {
    public static final SuggestionProvider<CommandSourceStack> ENTITIES = SuggestionProviders.register(VIdentifier.mod("entities"), (context, builder) -> {
    ...
    public static final SuggestionProvider<CommandSourceStack> BIOMES = SuggestionProviders.register(VIdentifier.mod("biomes"), (context, builder) -> {
