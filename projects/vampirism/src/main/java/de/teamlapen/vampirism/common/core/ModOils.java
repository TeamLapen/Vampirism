...
public class ModOils {
    ...
    public static final DeferredHolder<IOil, IOil> VAMPIRE_BLOOD = OILS.register("vampire_blood", () -> new Oil(0xb1096b));
    public static final DeferredHolder<IOil, IOil> SOVEREIGN_BLOOD = OILS.register("sovereign_blood", () -> new Oil(0xff1785));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> POISON_STRONG = OILS.register("poison_strong", () -> new EffectWeaponOil(MobEffects.POISON, 50, 15, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> WEAKNESS_STRONG = OILS.register("weakness_strong", () -> new EffectWeaponOil(MobEffects.WEAKNESS, 50, 15, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> SLOWNESS_STRONG = OILS.register("slowness_strong", () -> new EffectWeaponOil(MobEffects.SLOWNESS, 100, 15, 1));
    public static final DeferredHolder<IOil, EffectWeaponOil> HEALING = OILS.register("healing", () -> new EffectWeaponOil(MobEffects.INSTANT_HEALTH, 1, 5));
    public static final DeferredHolder<IOil, EffectWeaponOil> HEALING_STRONG = OILS.register("healing_strong", () -> new EffectWeaponOil(MobEffects.INSTANT_HEALTH, 1, 5, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> FIRE_RESISTANCE_STRONG = OILS.register("fire_resistance_strong", () -> new EffectWeaponOil(MobEffects.FIRE_RESISTANCE, 400, 20));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> SWIFTNESS_STRONG = OILS.register("swiftness_strong", () -> new EffectWeaponOil(MobEffects.SPEED, 200, 15, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> REGENERATION_STRONG = OILS.register("regeneration_strong", () -> new EffectWeaponOil(MobEffects.REGENERATION, 100, 10, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> NIGHT_VISION_STRONG = OILS.register("night_vision_strong", () -> new EffectWeaponOil(MobEffects.NIGHT_VISION, 200, 15));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> STRENGTH_STRONG = OILS.register("strength_strong", () -> new EffectWeaponOil(MobEffects.STRENGTH, 100, 10, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> JUMP_STRONG = OILS.register("jump_strong", () -> new EffectWeaponOil(MobEffects.JUMP_BOOST, 100, 20, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> WATER_BREATHING_STRONG = OILS.register("water_breathing_strong", () -> new EffectWeaponOil(MobEffects.WATER_BREATHING, 400, 15));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> INVISIBILITY_STRONG = OILS.register("invisibility_strong", () -> new EffectWeaponOil(MobEffects.INVISIBILITY, 200, 15));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> SLOW_FALLING_STRONG = OILS.register("slow_falling_strong", () -> new EffectWeaponOil(MobEffects.SLOW_FALLING, 400, 20));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> LUCK_STRONG = OILS.register("luck_strong", () -> new EffectWeaponOil(MobEffects.LUCK, 200, 20, 1));
    ...
    public static final DeferredHolder<IOil, EffectWeaponOil> HARM_STRONG = OILS.register("harm_strong", () -> new EffectWeaponOil(MobEffects.INSTANT_DAMAGE, 1, 5, 1));
    ...
    public static final DeferredHolder<IOil, EvasionOil> EVASION_STRONG = OILS.register("evasion_strong", () -> new EvasionOil(0x888800, 60, 1));
