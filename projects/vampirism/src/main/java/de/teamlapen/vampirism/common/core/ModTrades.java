...
public class ModTrades {
    ...
    public static final ResourceKey<VillagerTrade> FARMER_1_EMERALD_GARLIC = trade("skeleton_expert/1/emerald_bone");
    public static final ResourceKey<VillagerTrade> BUTCHER_3_EMERALD_HEART = trade("skeleton_expert/3/emerald_bone");
    public static final ResourceKey<VillagerTrade> MANSON_2_EMERALD_STONE = trade("skeleton_expert/3/emerald_bone");
    public static final ResourceKey<VillagerTrade> MANSON_2_EMERALD_CHISELED = trade("skeleton_expert/3/emerald_bone");

    public static final ResourceKey<VillagerTrade> WANDERER_1_EMERALD_ORCHID = trade("skeleton_expert/1/emerald_bone");
    public static final ResourceKey<VillagerTrade> WANDERER_1_EMERALD_ROOTS = trade("skeleton_expert/1/emerald_bone");
    public static final ResourceKey<VillagerTrade> WANDERER_1_EMERALD_GARLIC = trade("skeleton_expert/1/emerald_bone");
    public static final ResourceKey<VillagerTrade> WANDERER_1_EMERALD_DARK_SAPLING = trade("skeleton_expert/1/emerald_bone");
    public static final ResourceKey<VillagerTrade> WANDERER_1_EMERALD_CURSED_SAPLING = trade("skeleton_expert/1/emerald_bone");
    public static final ResourceKey<VillagerTrade> WANDERER_1_EMERALD_EARTH = trade("skeleton_expert/1/emerald_bone");
    ...
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_COAT_HEAD = trade("hunter_expert/3/soul_coat_head");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_COAT_CHEST = trade("hunter_expert/3/soul_coat_chest");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_COAT_LEGS = trade("hunter_expert/3/soul_coat_legs");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_COAT_FEET = trade("hunter_expert/3/soul_coat_feet");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_SWIFTNESS_HEAD = trade("hunter_expert/3/soul_swiftness_head");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_SWIFTNESS_CHEST = trade("hunter_expert/3/soul_swiftness_chest");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_SWIFTNESS_LEGS = trade("hunter_expert/3/soul_swiftness_legs");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_4_SOUL_SWIFTNESS_FEET = trade("hunter_expert/3/soul_swiftness_feet");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_5_SOUL_COAT_HEAD = trade("hunter_expert/3/soul_coat_head");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_5_SOUL_COAT_CHEST = trade("hunter_expert/3/soul_coat_chest");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_5_SOUL_COAT_LEGS = trade("hunter_expert/3/soul_coat_legs");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_5_SOUL_COAT_FEET = trade("hunter_expert/3/soul_coat_feet");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_5_SOUL_AXE = trade("hunter_expert/3/soul_axe");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_5_SOUL_CROSSBOW = trade("hunter_expert/3/soul_crossbow");
    public static final ResourceKey<VillagerTrade> HUNTER_EXPERT_5_SOUL_CROSSBOW_DOUBLE = trade("hunter_expert/3/soul_crossbow_double");

    public static final ResourceKey<VillagerTrade> PRIEST_1_EMERALD_SALT = trade("hunter_expert/1/emerald_salt");
    public static final ResourceKey<VillagerTrade> PRIEST_1_EMERALD_GARLIC = trade("hunter_expert/1/emerald_garlic");
    public static final ResourceKey<VillagerTrade> PRIEST_1_CANDLE_EMERALD = trade("hunter_expert/1/candle_emerald");
    public static final ResourceKey<VillagerTrade> PRIEST_2_EMERALD_HONEY = trade("hunter_expert/1/emerald_honey");
    public static final ResourceKey<VillagerTrade> PRIEST_2_HOLY_EMERALD = trade("hunter_expert/1/holy_emerald");
    public static final ResourceKey<VillagerTrade> PRIEST_3_EMERALD_GOLD = trade("hunter_expert/1/emerald_gold");
    public static final ResourceKey<VillagerTrade> PRIEST_3_HOLY_EMERALD = trade("hunter_expert/1/holy_emerald");
    public static final ResourceKey<VillagerTrade> PRIEST_3_EMERALD_CRUCIFIX = trade("hunter_expert/1/emerald_crucifix");
    public static final ResourceKey<VillagerTrade> PRIEST_4_HOLY_EMERALD = trade("hunter_expert/1/holy_emerald");
    public static final ResourceKey<VillagerTrade> PRIEST_4_EMERALD_CRUCIFIX = trade("hunter_expert/1/emerald_crucifix");
