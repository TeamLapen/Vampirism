...
public class ModTrades {
    ...
    static void bootstrapHunterExpert(BootstrapContext<VillagerTrade> context) {
        ...
        register(context, HUNTER_EXPERT_2_SOULS_ARROW_NORMAL, trade(new TradeCost(ModItems.SOUL_ORB_VAMPIRE, UniformGenerator.between(10,20)), new ItemStackTemplate(ModItems.QUARREL_NORMAL.get()),12, 5, Optional.empty(), List.of(SetItemCountFunction.setCount(UniformGenerator.between(8,16)).build())));
        register(context, HUNTER_EXPERT_2_SOULS_ARROW_VAMPIRE_KILLER, trade(new TradeCost(ModItems.SOUL_ORB_VAMPIRE, UniformGenerator.between(15,30)), new ItemStackTemplate(ModItems.QUARREL_NORMAL.get()),12, 5, Optional.empty(), List.of(SetItemCountFunction.setCount(UniformGenerator.between(8,16)).build())));
        register(context, HUNTER_EXPERT_2_SOULS_ARROW_SPITFIRE, trade(new TradeCost(ModItems.SOUL_ORB_VAMPIRE, UniformGenerator.between(20,35)), new ItemStackTemplate(ModItems.QUARREL_NORMAL.get()),12, 5, Optional.empty(), List.of(SetItemCountFunction.setCount(UniformGenerator.between(8,16)).build())));
        register(context, HUNTER_EXPERT_2_SOULS_ARROW_TELEPORT, trade(new TradeCost(ModItems.SOUL_ORB_VAMPIRE, UniformGenerator.between(25,40)), new ItemStackTemplate(ModItems.QUARREL_NORMAL.get()),12, 5, Optional.empty(), List.of(SetItemCountFunction.setCount(UniformGenerator.between(6,12)).build())));
