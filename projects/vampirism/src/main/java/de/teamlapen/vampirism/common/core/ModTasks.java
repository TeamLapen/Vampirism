...
public class ModTasks {
    ...
    static void createTasks(BootstrapContext<Task> context) {
        ...
        context.register(RANDOM_REFINEMENT_1, TaskBuilder.builder(RANDOM_REFINEMENT_1).defaultTitle().addRequirement(ModEntityTags.ADVANCED_HUNTER, 10).addRequirement(new ItemStack(Items.GOLD_INGOT, 2)).setReward(new RefinementItemReward((HolderSet<? extends IPlayableFaction<?>>) (Object) factions.getOrThrow(ModFactionTags.IS_VAMPIRE))).build());
        context.register(RANDOM_REFINEMENT_2, TaskBuilder.builder(RANDOM_REFINEMENT_2).defaultTitle().addRequirement(ModEntities.VAMPIRE_BARON.get(), 3).addRequirement(new ItemStack(Items.GOLD_INGOT, 2)).setReward(new RefinementItemReward((HolderSet<? extends IPlayableFaction<?>>) (Object) factions.getOrThrow(ModFactionTags.IS_VAMPIRE))).build());
        context.register(RANDOM_REFINEMENT_3, TaskBuilder.builder(RANDOM_REFINEMENT_3).defaultTitle().addRequirement(Stats.TRADED_WITH_VILLAGER, 15).addRequirement(new ItemStack(Items.GOLD_INGOT, 2)).setReward(new RefinementItemReward((HolderSet<? extends IPlayableFaction<?>>) (Object) factions.getOrThrow(ModFactionTags.IS_VAMPIRE))).build());
        context.register(RANDOM_RARE_REFINEMENT, TaskBuilder.builder(RANDOM_RARE_REFINEMENT).defaultTitle().addRequirement(Stats.RAID_WIN, 1).setReward(new RefinementItemReward((HolderSet<? extends IPlayableFaction<?>>) (Object) factions.getOrThrow(ModFactionTags.IS_VAMPIRE), IRefinementSet.Rarity.RARE)).build());
        ...
        context.register(V_CAPTURE_1, TaskBuilder.builder(V_CAPTURE_1).defaultTitle().addRequirement(FactionStats.CAPTURE_VILLAGE.get(), 1).setReward(new ItemStack(Items.EMERALD, 10)).build());
        context.register(V_CAPTURE_2, TaskBuilder.builder(V_CAPTURE_2).defaultTitle().addRequirement(FactionStats.CAPTURE_VILLAGE.get(), 1).setReward(new ItemStack(Items.EMERALD, 5)).build());
        ...
        context.register(HUNTER_LORD_1, TaskBuilder.builder(HUNTER_LORD_1).defaultTitle().unlockedBy(new LvlUnlocker(ModFactions.HUNTER.value().getHighestReachableLevel())).addRequirement(ModEntityTags.VAMPIRE, 50).addRequirement(new ItemStack(Items.GOLD_INGOT, 32)).addRequirement(FactionStats.WIN_VILLAGE_CAPTURE.get(), 3).setReward(new LordLevelReward(1, Component.translatable("task.vampirism.hunter_lord1.reward"))).build());
        ...
        context.register(HUNTER_LORD_5, TaskBuilder.builder(HUNTER_LORD_5).defaultTitle().unlockedBy(new LordLvlUnlocker(4, true)).addRequirement(ModEntityTags.VAMPIRE, 100).addRequirement(new ItemStack(Items.GOLD_INGOT, 64)).addRequirement(FactionStats.CAPTURE_VILLAGE.get(), 6).setReward(new LordLevelReward(5)).build());
        ...
        context.register(H_CAPTURE_1, TaskBuilder.builder(H_CAPTURE_1).defaultTitle().addRequirement(FactionStats.CAPTURE_VILLAGE.get(), 2).setReward(new ItemStack(ModItems.VAMPIRE_BLOOD_BOTTLE.get(), 10)).build());

        context.register(TOTEM_TOP, TaskBuilder.builder(TOTEM_TOP).defaultTitle().unlockedBy(new LvlUnlocker(5)).addRequirement(new ItemStack(Items.OBSIDIAN, 32)).addRequirement(new ItemStack(Items.DIAMOND, 1)).addRequirement(ModEntityTags.ZOMBIES, 32).setReward(new ItemStack(FactionBlocks.TOTEM_TOP_CRAFTED.get())).build());
        context.register(OBLIVION_POTION, TaskBuilder.builder(OBLIVION_POTION).defaultTitle().addRequirement(ItemDataUtils.createPotion(Potions.POISON)).addRequirement(new ItemStack(ModItems.VAMPIRE_BLOOD_BOTTLE.get())).setReward(new ItemStack(FactionItems.OBLIVION_POTION.get())).build());
        context.register(OBLIVION_POTION_PURE_BLOOD_1, TaskBuilder.builder(OBLIVION_POTION_PURE_BLOOD_1).defaultTitle().unlockedBy(new LvlUnlocker(1, 3)).addRequirement(ItemDataUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement(new ItemStack(ModItems.PURE_BLOOD_0.get())).setReward(new ItemStack(FactionItems.OBLIVION_POTION.get())).build());
        context.register(OBLIVION_POTION_PURE_BLOOD_2, TaskBuilder.builder(OBLIVION_POTION_PURE_BLOOD_2).defaultTitle().unlockedBy(new LvlUnlocker(4, 6)).addRequirement(ItemDataUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement(new ItemStack(ModItems.PURE_BLOOD_1.get())).setReward(new ItemStack(FactionItems.OBLIVION_POTION.get())).build());
        context.register(OBLIVION_POTION_PURE_BLOOD_3, TaskBuilder.builder(OBLIVION_POTION_PURE_BLOOD_3).defaultTitle().unlockedBy(new LvlUnlocker(7, 9)).addRequirement(ItemDataUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement(new ItemStack(ModItems.PURE_BLOOD_2.get())).setReward(new ItemStack(FactionItems.OBLIVION_POTION.get())).build());
        context.register(OBLIVION_POTION_PURE_BLOOD_4, TaskBuilder.builder(OBLIVION_POTION_PURE_BLOOD_4).defaultTitle().unlockedBy(new LvlUnlocker(10, 12)).addRequirement(ItemDataUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement(new ItemStack(ModItems.PURE_BLOOD_3.get())).setReward(new ItemStack(FactionItems.OBLIVION_POTION.get())).build());
        context.register(OBLIVION_POTION_PURE_BLOOD_5, TaskBuilder.builder(OBLIVION_POTION_PURE_BLOOD_5).defaultTitle().unlockedBy(new LvlUnlocker(13, 14)).addRequirement(ItemDataUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)).addRequirement(new ItemStack(ModItems.PURE_BLOOD_4.get())).setReward(new ItemStack(FactionItems.OBLIVION_POTION.get())).build());
