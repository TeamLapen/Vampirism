...
public class ModTasks {
    ...
    static void createTasks(BootstrapContext<Task> context) {
        ...
        TaskBuilder.builder().addRequirement(ModEntityTags.ADVANCED_HUNTER, 10).addRequirement(new ItemStackTemplate(Items.GOLD_INGOT, 2)).setReward(new de.teamlapen.faction.common.factions.tasks.reward.RefinementItemReward((HolderSet<? extends IPlayableFaction<?>>) (Object) factions.getOrThrow(VampirismTags.Factions.IS_VAMPIRE))).build(context::register, RANDOM_REFINEMENT_1);
        TaskBuilder.builder().addRequirement(ModEntities.VAMPIRE_BARON.get(), 3).addRequirement(new ItemStackTemplate(Items.GOLD_INGOT, 2)).setReward(new de.teamlapen.faction.common.factions.tasks.reward.RefinementItemReward((HolderSet<? extends IPlayableFaction<?>>) (Object) factions.getOrThrow(VampirismTags.Factions.IS_VAMPIRE))).build(context::register, RANDOM_REFINEMENT_2);
        TaskBuilder.builder().addRequirement(Stats.TRADED_WITH_VILLAGER, 15).addRequirement(new ItemStackTemplate(Items.GOLD_INGOT, 2)).setReward(new de.teamlapen.faction.common.factions.tasks.reward.RefinementItemReward((HolderSet<? extends IPlayableFaction<?>>) (Object) factions.getOrThrow(VampirismTags.Factions.IS_VAMPIRE))).build(context::register, RANDOM_REFINEMENT_3);
