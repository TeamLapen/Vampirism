...
public record GenericParticleOptions(Identifier texture, int maxAge, int color, float speed) implements ParticleOptions {

    public static final MapCodec<GenericParticleOptions> CODEC = RecordCodecBuilder.mapCodec((p_239803_0_) -> p_239803_0_
            .group(
                    Identifier.CODEC.fieldOf("texture").forGetter(GenericParticleOptions::texture),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, GenericParticleOptions> STREAM_CODEC = StreamCodec.composite(
            Identifier.STREAM_CODEC, GenericParticleOptions::texture,
    ...
    public GenericParticleOptions(Identifier texture, int maxAge, int color) {
