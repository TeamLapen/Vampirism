package de.teamlapen.vampirism.common.world.structures;

import com.google.common.collect.ImmutableMap;
import com.mojang.datafixers.util.Pair;
import de.teamlapen.vampirism.api.util.VIdentifier;
import de.teamlapen.vampirism.common.config.ModConfig;
import de.teamlapen.vampirism.misc.mixin.JigsawPlacerMixin;
import de.teamlapen.vampirism.misc.mixin.accessor.ProcessorListsAccessor;
import de.teamlapen.vampirism.misc.mixin.accessor.StructureTemplatePoolAccessor;
...
public class VanillaStructureModifications {
    ...
    private static @NotNull Map<Identifier, BiomeType> getDefaultPools() {
        return Map.ofEntries(Map.entry(VIdentifier.mc("village/plains/houses"), VanillaStructureModifications.BiomeType.PLAINS), Map.entry(VIdentifier.mc("village/desert/houses"), VanillaStructureModifications.BiomeType.DESERT), Map.entry(VIdentifier.mc("village/savanna/houses"), VanillaStructureModifications.BiomeType.SAVANNA), Map.entry(VIdentifier.mc("village/taiga/houses"), VanillaStructureModifications.BiomeType.TAIGA), Map.entry(VIdentifier.mc("village/snowy/houses"), VanillaStructureModifications.BiomeType.SNOWY));
    }
    ...
    private static void addTotem(@NotNull RegistryAccess reg, @NotNull Map<Identifier, VanillaStructureModifications.BiomeType> pools) {
        ResourceKey<StructureProcessorList> TOTEM_FACTION_PROCESSOR = ResourceKey.create(Registries.PROCESSOR_LIST, VIdentifier.mod("totem_faction"));
