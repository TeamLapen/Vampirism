...
public class ModDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Long>> DETRITION_DEFERRED_UNTIL = ITEM_DATA_COMPONENTS.registerComponentType(VampirismDataComponents.Keys.DETRITION_DEFERRED_UNTIL.getPath(), builder -> builder.persistent(Codec.LONG).networkSynchronized(ByteBufCodecs.LONG));
