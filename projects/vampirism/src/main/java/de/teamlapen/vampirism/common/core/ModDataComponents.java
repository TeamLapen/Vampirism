...
public class ModDataComponents {
    ...
    public static final DeferredRegister<DataComponentPredicate.Type<?>> ITEM_DATA_COMPONENTS_PREDICATES = DeferredRegister.create(Registries.DATA_COMPONENT_PREDICATE_TYPE, REFERENCE.MODID);
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<AppliedOilContent>> APPLIED_OIL = ITEM_DATA_COMPONENTS.register(VampirismDataComponents.Keys.APPLIED_OIL.getPath(), () -> DataComponentType.<AppliedOilContent>builder().persistent(AppliedOilContent.CODEC).networkSynchronized(AppliedOilContent.STREAM_CODEC).build());
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<ItemStackTemplate>> CONTAINED_PROJECTILES = ITEM_DATA_COMPONENTS.registerComponentType(VampirismDataComponents.Keys.CONTAINED_PROJECTILES.getPath(), builder -> builder.persistent(ItemStackTemplate.CODEC).networkSynchronized(ItemStackTemplate.STREAM_CODEC).cacheEncoding());
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<ItemStackTemplate>> SHATTERED_ARMOR = ITEM_DATA_COMPONENTS.registerComponentType(VampirismDataComponents.Keys.SHATTERED_ARMOR.getPath(), builder -> builder.persistent(ItemStackTemplate.CODEC).networkSynchronized(ItemStackTemplate.STREAM_CODEC));
    ...
    static void register(IEventBus eventBus) {
        ...
        ITEM_DATA_COMPONENTS_PREDICATES.register(eventBus);
    }
}
