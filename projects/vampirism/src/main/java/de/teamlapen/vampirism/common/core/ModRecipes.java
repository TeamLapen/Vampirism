...
public class ModRecipes {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<SerumFromPotionRecipe>> SERUM_FROM_POTION_RECIPE = RECIPE_SERIALIZERS.register("serum_from_potion", () -> new CustomRecipe.Serializer<>(SerumFromPotionRecipe::new));
