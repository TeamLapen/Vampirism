...
public class ModRecipes {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<SerumFromPotionRecipe.SingleSerumFromPotionRecipe>> SINGLE_SERUM_FROM_POTION_RECIPE = RECIPE_SERIALIZERS.register("serum_from_single_potion", () -> new CustomWeaponTableRecipe.Serializer<>(SerumFromPotionRecipe.SingleSerumFromPotionRecipe::new));
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<SerumFromPotionRecipe.DoubleSerumFromPotionRecipe>> DOUBLE_SERUM_FROM_POTION_RECIPE = RECIPE_SERIALIZERS.register("serum_from_double_potion", () -> new CustomWeaponTableRecipe.Serializer<>(SerumFromPotionRecipe.DoubleSerumFromPotionRecipe::new));
