...
public class VampireMinionStatsScreen extends MinionStatsScreen<VampireMinionEntity.VampireMinionData, VampireMinionEntity> {
    ...
    protected void initStatRows() {
        addStatRow(new StatRow(Component.translatable("text.vampirism.minion.stats.inventory_level"),VampireMinionEntity.VampireMinionData.MAX_LEVEL_INVENTORY,() ->  String.valueOf(this.minionData.getInventorySize()), () -> this.minionData.getInventoryLevel()));
