...
public class HunterTableMenu extends ItemCombinerMenu {
    ...
    public HunterTableMenu(int id, Inventory playerInventory, ContainerLevelAccess worldPosCallable) {
    ...
    protected static ItemCombinerMenuSlotDefinition createInputSlotDefinitions(Player player) {
        ...
        return ItemCombinerMenuSlotDefinition.create()
                ...
                .withSlot(2, 69, 28, stack -> stack.getItem() instanceof PureBloodItem && tableRequirement.filter(req -> req.pureBloodLevel() <= (stack.getItem() instanceof PureBloodItem pure ? pure.getLevel(stack) : -1)).isPresent())
    ...
    public static class Factory implements IContainerFactory<HunterTableMenu> {
        ...
        @Override
        public HunterTableMenu create(int windowId, Inventory inv, RegistryFriendlyByteBuf data) {
