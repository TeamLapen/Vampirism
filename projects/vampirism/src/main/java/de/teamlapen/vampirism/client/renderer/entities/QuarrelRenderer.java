...
public class QuarrelRenderer extends ArrowRenderer<QuarrelEntity, ArrowRenderState> {

    private static final Identifier RES_ARROW = VIdentifier.mc("textures/entity/projectiles/arrow.png");

    public QuarrelRenderer(EntityRendererProvider.@NotNull Context context) {
        super(context);
    }
