...
import de.teamlapen.vampirism.common.world.entity.IDefaultTaskMasterEntity;
...
public class VampireTaskMasterEntity extends VampireBaseEntity implements IDefaultTaskMasterEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, PathfinderMob.class, 10, 1.0, 1.1, IFactionPredicate.builder(getFaction()).onlyNonPlayers().targetFaction(ModFactions.HUNTER).build()));
