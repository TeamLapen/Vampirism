 ...
 * <br>
 * <br>
 * {@link IEntityBlood} can be optioned here as well as converting handler and overlay texture
 * <br>
 * <br>
...
public interface IVampirismEntityRegistry {
     ...
     * @implSpec This will copy all relevant data from the original entity to the converted entity using {@link  IConvertingHandler#createFrom(net.minecraft.world.entity.PathfinderMob)}
     */
    @Nullable
    ...
    /**
     * Get the {@link IConverterEntry} for the given creature.
     *
    ...
    /**
     * Get the {@link IEntityBlood} for the given creature.<br>
     * <br>
