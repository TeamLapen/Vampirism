...
public class TaskRequirement {
    ...
    public TaskRequirement(Collection<Requirement<?>> requirements) {
    ...
    public interface Requirement<T> {
        ...
        Codec<Requirement<?>> CODEC = Codec.lazyInitialized(() -> FactionRegistries.TASK_REQUIREMENT.get().byNameCodec()).dispatch(Requirement::codec, Function.identity());
