package de.teamlapen.factions.api.actions;
...
public interface IActionHandler<T extends IFactionPlayer<T> & ISkillPlayer<T>> extends ISyncable {
    ...
    /**
     * Lasting actions are deactivated here, which fires the {@link de.teamlapen.factions.api.event.ActionEvent.ActionDeactivatedEvent}
     *
