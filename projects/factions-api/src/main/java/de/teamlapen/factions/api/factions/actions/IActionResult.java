...
public interface IActionResult {
    ...
    IActionResult RESTRICTED = new Result(false, Component.translatable("text.factions.action.restricted"));
    IActionResult NOT_UNLOCKED = new Result(false, Component.translatable("text.factions.action.not_unlocked"));
